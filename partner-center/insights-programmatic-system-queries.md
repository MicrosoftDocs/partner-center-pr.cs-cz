...
---
# <a name="list-of-system-queries-for-partner-insights-programmatic-access"></a>Seznam systémových dotazů pro programový přístup k partner Insights

V [rozhraní API pro vytváření sestav](insights-programmatic-access-paradigm.md#create-report-api) přímo s QueryId se dají použít následující systémové dotazy. Systémové dotazy jsou jako sestavy exportu v partnerském centru po dobu šesti měsíců výpočtu (6 min).

Další podrobnosti o názvech, atributech a popisech sloupců najdete v [definicích dat](insights-data-definitions.md) .

V následujících oddílech jsou uvedeny dotazy sestav pro různé sestavy.

## <a name="customers"></a>Zákazníci

Zákazníci sestavu za posledních šest měsíců

ID dotazu: `6664daf3-c161-423a-92a1-0ea6db2c0384`

### <a name="report-query"></a>Dotaz sestavy
```sql
...
## <a name="seats-subscriptions-and-revenue"></a>Předplatné a tržby na sedadle

Oznámení o licencích, předplatných a výnosech za posledních šest měsíců
...
## <a name="office-usage"></a>Office Využívání
...
## <a name="dynamics-usage"></a>Využití Dynamics

Sestava DynamicsUsage po dobu šesti měsíců
...
## <a name="power-bi-usage"></a>Využití Power BI

Sestava PowerBIUsage po dobu šesti měsíců
...
## <a name="ems-usage"></a>Použití EMS

Sestava EMSUsage po dobu šesti měsíců
...
## <a name="competency-performance-requirement-report"></a>Sestava požadavků na výkon kompetence

Sestava CompetencyPeformanceRequirement po dobu šesti měsíců
...
## <a name="cloud-products-reseller-performance"></a>Výkon prodejců cloudových produktů

### <a name="report-description"></a>Popis sestavy

Sestava CloudProductsResellerPerformance po dobu šesti měsíců
...
## <a name="clas-agreement-renewal-propensity"></a>ProCLASy obnovení smlouvy

Sestava CLASAgreementRenewalsPropensity po dobu šesti měsíců
...
## <a name="clas-azure-propensity"></a>CLAS PROPER Azure

Sestava CLASAzurePropensity po dobu šesti měsíců
...
## <a name="clas-d365-propensity"></a>CLAS D365 Proper

Sestava CLASD365Propensity po dobu šesti měsíců
...
## <a name="clas-m365-propensity"></a>CLAS M365 Proper

Sestava CLASM365Propensity po dobu šesti měsíců
...
## <a name="teams-usage-3p-apps"></a>Teams Využití aplikací 3P

Sestava TeamsUsage3PApps po dobu šesti měsíců
...
## <a name="teams-usage-workload"></a>zatížení Teams využití

Sestava TeamsUsageWorkload po dobu šesti měsíců
...
## <a name="teams-usage-meetings-and-calls"></a>Teams schůzky a volání využití

Sestava TeamsUsageMeetingsAndCalls po dobu šesti měsíců
...
## <a name="competency-summary-history"></a>Souhrnná historie kompetencí

Sestava CompetencySummaryHistory po dobu šesti měsíců
...
## <a name="training-completion"></a>Dokončení školení

Sestava dokončení školení po dobu šesti měsíců
...
Sestava Microsoft Learn za posledních šest měsíců
...
- [Ukázková aplikace pro přístup k datům služby partner Insights Analytics](insights-programmatic-sample-application.md)