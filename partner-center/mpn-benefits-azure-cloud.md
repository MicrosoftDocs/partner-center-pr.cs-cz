...
- Odběry na základě licencí (například Office 365)

### <a name="usage-based-subscriptions-with-two-types-of-microsoft-azure-credit"></a>Předplatná založená na využití se dvěma typy Microsoft Azure kreditu

Existují dva typy předplatných založených na využití, které byste mohli obdržet, v závislosti na aktivních nabídkách, které jsou k dispozici pro vaše Microsoft Partner Network členství. Tyto aktivní nabídky můžou zahrnovat Microsoft Action Pack, Silver Competency nebo Gold Competency. 

Mezi dva typy předplatných založených na využití, která se dají zřídit pro tyto nabídky, patří *měsíční kredit Azure* a/nebo *Azure Hromadná (roční) kredit*:

- **Zřizování pro měsíční kredit Azure:** Může se zobrazit jako $100/měsíc (nebo ekvivalent v místní měně).<br/>
*a/nebo*
- **Zřizování pro Azure v hromadném (ročním) kreditu:** Může to vypadat nějak takto: $6000/year, $12000/Year a/nebo $13000/Year (nebo každý z nich má ekvivalent v místní měně).

Pokud chcete aktivovat předplatné Microsoft Azure v partnerském centru, je potřeba přiřadit přístup k uživateli v rámci společnosti (nebo uživatel typu Host). Uživatel již musí mít ve svém tenantovi Azure Active Directory vytvořenou položku uživatele. Pak postupujte podle následujících kroků:

1. Jakmile budete mít jistotu, že uživatel má v tenantovi Azure AD záznam uživatele, přihlaste se na [řídicí panel](https://partner.microsoft.com/dashboard)partnerského centra.

1. V nabídce vlevo v navigaci vyberte **MPN** a potom **výhody** a pak **Azure a Cloud**.

1. Vyberte šipku dolů ve sloupci napravo, **Zobrazit podrobnosti** pro předplatné založené na využití, které chcete aktivovat. 

1. Vyhledejte oblast **přiřazení uživatelů** na stránce **Azure a Cloud Products** partnerského centra (níže). Pak vyberte možnost **přiřadit uživatele** a přiřaďte tak tomuto uživateli zvýhodněné předplatné na základě využití. 
...
- Když přiřadíte měsíční kredit Azure, třeba $100 za měsíc (nebo ekvivalent v místní měně), Všimněte si, že můžete kdykoli přidat nebo odebrat uživatele z tohoto předplatného.

- Když přiřadíte kredit Azure do hromadného (ročního), pamatujte na to, že možnost **Odebrat** není k dispozici v partnerském centru. Místo toho je nutné přenést hromadný kredit na někoho jiného během registračního roku. Bezplatné předplatné Azure v rámci hromadného (ročního) kreditu se také nedá kombinovat s jinými nabídkami licencování, předplacení nebo kreditů (například Microsoft smlouva Enterprise, Cloud Solution Provider, Systém Azure v rámci licenčního programu Open, Azure Pass, Microsoft Action Pack atd.).

### <a name="license-based-subscriptions"></a>Odběry na základě licencí

V části odběry na základě licencí na stránce Azure a Cloud Products najdete všechny cloudové produkty, které pro aktivaci vyžadují kód Product Key, jako je Microsoft O365, Microsoft Dynamics, Microsoft Intune, Azure AD Basic, Power BI atd. Tyto produkty jsou nabízeny na základě typu aktivní nabídky, kterou máte k dispozici jako partner v Microsoft Partner Network. Takové nabídky můžou zahrnovat Microsoft Action Pack, Silver Competency členství nebo Gold Competency členství.

Aktivace předplatného založeného na licencích: 

1. Vyhledejte konkrétní předplatné na stránce Azure a Cloud Products. 

1. Vyberte šipku rozevíracího seznamu ve sloupci vpravo, **Zobrazit podrobnosti** pro toto předplatné. 

1. Přečtěte si pokyny na následující stránce. Tím se dozvíte víc o tom, jak tyto klíče uplatnit. 
...
1. Až budete připraveni k uplatnění klíče, vyberte možnost **návod k aktivaci** , který se nachází v dolní části této stránky.
   - Pokud chcete aktivovat nové předplatné nebo pokud už vypršela platnost stávajícího předplatného, otevřete **privátní nebo anonymním prohlížeč** a pak zkopírujte a vložte následující odkaz a postupujte podle pokynů:
...
1. Na bočním panelu vyberte **uplatnit kód Product Key**. 

1. Zadejte kód Product Key a pak kliknutím na **ověřit** ověřte podrobnosti klíče. 

1. Pro dokončení procesu vyberte **uplatnit** .

   > [!NOTE]
   > Každý kód Product Key poskytuje uživatelům 12 měsíců služby od data uplatnění kódu Product Key. Pokud ale stávající uživatelé mají datum předčasného obnovení, budou se průměrně vydávat dvě data, aby bylo snazší spravovat vaše předplatná na základě jediného koncového data všech vašich uživatelů. Během výpočtu se nepřidá ani neztratí žádný čas. Výpočet použitý na průměrně vyprší ze dvou kalendářních dat:
   >
   > **Výpočet:** \[ A (počáteční uživatelé) x B (zbývající čas u předplatného) \+ C (noví uživatelé) x (12 měsíců) \] ÷ Celkový počet uživatelů = nový zbývající čas.

## <a name="activate-a-subscription-for-the-first-time"></a>První Aktivace předplatného

Pokud poprvé aktivujete předplatné, postupujte podle těchto kroků. Tento postup můžete použít také v případě, že je vaše předplatné ve stavu zakázáno nebo vypršelo:

1. Zkopírujte a vložte odkaz níže do **soukromého okna nebo do okna prohlížeče anonymním**.
   
   [https://signup.microsoft.com/productkeystart](https://signup.microsoft.com/productkeystart)
1. Ujistěte se, že jste přihlášeni ke správnému Azure Active Directorymu účtu tenanta. Po přihlášení ověřte podrobnosti o tenantovi.
