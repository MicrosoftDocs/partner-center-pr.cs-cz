...
## <a name="readiness-changes-to-the-cloud-solution-provider-csp-customer-address-validation-api-going-live-in-june-testing-capability-now-available"></a><a name="19"></a>Připravenost: změny v rozhraní API pro ověřování adres zákazníka v červnu v provozu poskytovatele Cloud Solution Provider (CSP) možnost testování je teď dostupná.
...
PSČ US vrátí další 4 číslice + spojovník – například 12345-6789.
...
Pokud potřebujete podporu pro vaše operace s Microsoftem, obraťte se na svého partnera, který podporuje skupinu Yammer.
...
________________
## <a name="new-exchange-admin-center-eac-experience"></a><a name="18"></a>Nové prostředí v centru pro správu Exchange (EAC)
...
________________
## <a name="microsoft-operations-introducing-the-product-launch-calendar"></a><a name="17"></a>Operace s Microsoftem: Úvod do kalendářního spuštění produktu
...
________________
## <a name="changes-to-csp-customer-onboarding-requirements"></a><a name="16"></a>Změny požadavků na registraci zprostředkovatele CSP pro zákazníky
...
________________
## <a name="corrections-made-to-march-1-2021-perpetual-software-price-list"></a><a name="15"></a>Opravy provedené 1. března 2021, což je trvalá Ceníková cena softwaru
...
- Odebrané nebo nepodporované trhy: AE, AF, AL, AM, AO, BA, BB, BD, BH, BM, BN, BO, BR, BS, ČERNOBÍLá, do, BZ, CI, CL,, CM, CO, CR, SH, DO, DZ, ES, např. ET, FJ, FO, GE, GH, GT, HN, IL, IN, SWEETIQ, JM, JO, KE, KG, ky, LY, MA, MC, MD, já , MN, MO, MÍ, NA, NG, NI, NP, OM, PA, PE, PH, PK, PR, PY, QA, RS, RU, TN, SG, SN, SV, TH, TJ, TM, TN, TT, TZ, ZM, ZW
...
- V části [kódy zemí v oblasti](/azure/marketplace/commercial-marketplace-co-sell-countries) najdete popisné mapování obou zkratek na země.
________________
## <a name="sdk-release-on-net-standard-v1170"></a><a name="14"></a> Vydání sady SDK na .NET Standard (v 1.17.0)
...
Přidání nových [typů operací](/partner-center/develop/auditing-resources) pro znalost, kdy zákazník schválil a ukončil DAP.
...
Přidali jsme nové [typy prostředků a operací](/partner-center/develop/auditing-resources) pro podporu scénáře role adresáře zákazníka.
...
________________
## <a name="csp-commercial-marketplace-offer-and-fy21-csp-incentives-for-eligible-offers"></a><a name="13"></a>Nabídky komerčního marketplace CSP a pobídky FY21 CSP pro způsobilé nabídky
...
Nepřímí poskytovatelé a partneři s přímým vyúčtováním v Cloud Solution Provider programu 

### <a name="details"></a>Podrobnosti

Nepřímí poskytovatelé a partneři s přímým vyúčtováním v programu Cloud Solution Provider mohou prodávat nabídky třetích stran a získat pobídku pro rebace za každou oprávněnou nabídku třetí strany, která se Partnerské centrum nebo Azure Portal. Pobídka bude ve formě slev z fakturovaných prodejů pro způsobilé nabídky a je k dispozici do **30. června 2021.**  

Pokračujte v seznamování s touto pobídkou nabídky CSP na komerčním marketplace níže a kontaktujte své zákazníky ještě dnes, abyste identifikovali správné nabídky, které jim umožní trvalé úspěchy a digitální transformaci.

Spolupracujeme s nezávislými výrobci softwaru (ISV), aby zákazníkům Microsoftu přinesli na trh nejnovější řešení IaaS a SaaS. Vydavatelé ISV mají možnost povolit prodej svých nabídek prostřednictvím partnerského kanálu Microsoftu. Naše nabídky s nárokem na pobídky spadají do dvou kategorií:
...
- [Cloud Solution Provider prostředků pobídek pro nepřímé poskytovatele](https://partner.microsoft.com/asset/collection/cloud-solution-provider-indirect-provider-incentive-resources#/)
...
________________
## <a name="power-bi-premium-offer-naming-and-prerequisite-update"></a><a name="12"></a>Power BI Premium nabídky pojmenování a aktualizace předpokladů
...
Finální ceník 1. dubna 2021 se aktualizuje, aby byl srozumitelný pro pojmenování a/nebo požadované informace pro Power BI Premium na uživatele.

### <a name="impacted-audience"></a>Ovlivněná cílová skupina

Cloud Solution Provider (CSP) a nepřímí partneři

### <a name="details"></a>Podrobnosti

Finální ceník 1. dubna 2021 se aktualizuje, aby byl srozumitelný pro pojmenování a/nebo požadované informace pro Power BI Premium na uživatele.

Až do aktualizace konečného ceníku použijte informace v této části, abyste zajistili, že je objednán správný produkt.

Následující podrobnosti ukazují ovlivněnou SKU a podrobnosti o požadavcích.

| Zobrazovaný název nabídky ve verzi Preview ceníku 1. března |  Aktualizovaný zobrazovaný název nabídky k 1. dubnu finální ceník| ID nabídky |
| ------ | ----------- | ----------- |
| Power BI Premium na uživatele Add-On (ceny pro neziskové pracovníky)  |  Power BI Premium na uživatele Add-On **(Office) (ceny** pro neziskové pracovníky)   | 31c03289-47ab-4ab0-8df1-03742c127ac6   |

Zákazníci musí mít některý z následujících požadavků na nákup této nabídky:

| Zobrazovaný název nabídky | ID nabídky |
| ------ | ----------- |
| Microsoft 365 E5 (ceny pro neziskové pracovníky)  |  31bedf01-9e57-4ece-a53a-d3656a563931   |
|   Microsoft 365 E5 bez audiokonference (ceny pro neziskové pracovníky)|  b456810a-c414-4e07-98fc-ef74e8175a09|
|   Office 365 E5 (ceny pro neziskové pracovníky)| ce139fe5-8bd5-47ed-a5be-07c286f8b9e    |
|   Zkušební verze Office 365 E5 (Ceny pro neziskové pracovníky)|  2f192efe-608a-4c9c-9d19-2b0b70b0962e|
...
## <a name="march-price-updates-for-microsoft-365-f3"></a><a name="11"></a> Březnové aktualizace cen pro Microsoft 365 F3
...
## <a name="update-a-legal-company-name-through-partner-center"></a><a name="10"></a> Aktualizace názvu právní společnosti prostřednictvím partnerského centra
...
________________
## <a name="update-to-cloud-solution-provider-csp-program-evolution-and-open-license-program-changes"></a><a name="9"></a> Aktualizace pro vývoj programu Cloud Solution Provider (CSP) a Open License změny programu
...
_______________
## <a name="update-to-a-previous-announcement-premium-assessments-an-add-on-to-compliance-manager"></a><a name="8"></a>Aktualizace na předchozí oznámení: posouzení Premium, doplněk ke Správci dodržování předpisů
...
________________
## <a name="migrate-your-solutions-from-one-commercial-partner-ocp-go-to-market-gtm-to-the-microsoft-commercial-marketplace"></a><a name="7"></a> Migrace řešení od jednoho komerčního partnera (OCP) přejít na trh (GTM) do komerčního tržiště Microsoftu
...
________________
## <a name="programmatic-access-to-commercial-marketplace-analytics"></a><a name="6"></a>Programový přístup k komerčním obchodům na webu Marketplace
...
Partneři teď můžou programově přistupovat ke analytickým sestavám a monitorovat prodej, hodnotit výkon a optimalizovat nabídky na komerčním webu Marketplace.

### <a name="impacted-audience"></a>Ovlivněná cílová skupina

Partneři s nabídkami na komerčním webu Marketplace.

### <a name="details"></a>Podrobnosti

Rozhraní API pro přístup k obchodním sestavám na webu Marketplace vám umožní asynchronně naplánovat vlastní sestavy analytických dat.

Tato funkce umožňuje definovat dotazy a šablony vytváření sestav podle vašich potřeb, nastavit plán a získat včas a důvěryhodné sestavy v naplánovaných intervalech.

### <a name="next-steps"></a>Další kroky

Další informace najdete v tématu Začínáme [s programovým přístupem k analýzám](/azure/marketplace/analytics-get-started).

### <a name="questions"></a>Máte otázky?

Pokud máte další dotazy, obraťte se na [podporu](https://go.microsoft.com/fwlink/?linkid=2165533) .
