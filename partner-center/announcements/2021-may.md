...
<span data-ttu-id="d6824-125">**Kdy se pro nepřímého prodejce sandboxu automaticky vytvoří role agenta pro správu?**</span><span class="sxs-lookup"><span data-stu-id="d6824-125">**When will the admin agent role be automatically created for the sandbox indirect reseller?**</span></span>
...
### <a name="details"></a><span data-ttu-id="d6824-151">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="d6824-151">Details</span></span>
...
### <a name="categories"></a><span data-ttu-id="d6824-162">Kategorie</span><span class="sxs-lookup"><span data-stu-id="d6824-162">Categories</span></span>
...
- <span data-ttu-id="d6824-185">Státní správa[(podmínky způsobilosti)](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=6)</span><span class="sxs-lookup"><span data-stu-id="d6824-185">Government ([eligibility requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=6))</span></span>
...
- [<span data-ttu-id="d6824-195">Reseller Open License to CSP transition materials</span><span class="sxs-lookup"><span data-stu-id="d6824-195">Reseller Open License to CSP transition materials</span></span>](https://partner.microsoft.com/resources/collection/reseller-open-license-to-csp-transition-materials#/)
...
- <span data-ttu-id="d6824-234">Platby v rámci pobídek budou ve stejné měně jako fakturační měna partnera.</span><span class="sxs-lookup"><span data-stu-id="d6824-234">Incentive payouts will be in the same currency as the partner’s invoice currency.</span></span>
...
### <a name="summary"></a><span data-ttu-id="d6824-245">Souhrn</span><span class="sxs-lookup"><span data-stu-id="d6824-245">Summary</span></span>
...
#### <a name="who-is-impacted-by-this-change"></a><span data-ttu-id="d6824-255">Na koho tato změna má vliv?</span><span class="sxs-lookup"><span data-stu-id="d6824-255">Who is impacted by this change?</span></span>
...
### <a name="resources"></a><span data-ttu-id="d6824-267">Zdroje informací</span><span class="sxs-lookup"><span data-stu-id="d6824-267">Resources</span></span>
...
<span data-ttu-id="d6824-279">Partneři CSP s přímým vyúčtováním a nepřímí poskytovatelé</span><span class="sxs-lookup"><span data-stu-id="d6824-279">CSP direct bill partners and indirect providers</span></span>
...
<span data-ttu-id="d6824-304">Máte dotazy k nějakém dalšímu tématu CSP?</span><span class="sxs-lookup"><span data-stu-id="d6824-304">Questions on any other CSP topic?</span></span> <span data-ttu-id="d6824-305">Navštivte stránku [Partnerské centrum podpory.](https://partner.microsoft.com/support/?stage=1)</span><span class="sxs-lookup"><span data-stu-id="d6824-305">Visit the [Partner Center support](https://partner.microsoft.com/support/?stage=1) page.</span></span>
...
<span data-ttu-id="d6824-318">Další informace najdete v našem průvodci [získáním přehledů referenčních](../referral-insights.md)Partnerské centrum .</span><span class="sxs-lookup"><span data-stu-id="d6824-318">Learn more by viewing our guide to [Get referral insights in Partner Center](../referral-insights.md).</span></span>
...
### <a name="details"></a><span data-ttu-id="d6824-330">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="d6824-330">Details</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="d6824-343">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="d6824-343">Impacted audience</span></span>
...
### <a name="details"></a><span data-ttu-id="d6824-368">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="d6824-368">Details</span></span>
...
### <a name="summary"></a><span data-ttu-id="d6824-380">Souhrn</span><span class="sxs-lookup"><span data-stu-id="d6824-380">Summary</span></span>
...
<span data-ttu-id="d6824-403">Pokud máte k těmto nabídce nějaké dotazy, zkontrolujte příslušné komunity Yammeru.</span><span class="sxs-lookup"><span data-stu-id="d6824-403">If you have any questions about these offers, check your relevant Yammer communities.</span></span>
...
#### <a name="expanding-opportunities-for-partners"></a><span data-ttu-id="d6824-417">Příležitosti k rozšíření pro partnery</span><span class="sxs-lookup"><span data-stu-id="d6824-417">Expanding opportunities for partners</span></span>
...
### <a name="questions"></a><span data-ttu-id="d6824-430">Máte otázky?</span><span class="sxs-lookup"><span data-stu-id="d6824-430">Questions?</span></span>

<span data-ttu-id="d6824-431">Pokud máte dotazy k těmto nabídekm, podívejte se na příslušné komunity Yammeru.</span><span class="sxs-lookup"><span data-stu-id="d6824-431">For questions about these offers, check your relevant Yammer communities.</span></span> 

________________
## <a name="final-reminder-deprecation-of-get-qualification-on-may-6-2021"></a><a name="4"></a><span data-ttu-id="d6824-432">Závěrečné připomenutí: Vyněcování kvalifikace GET 6. května 2021</span><span class="sxs-lookup"><span data-stu-id="d6824-432">Final reminder: Deprecation of GET qualification on May 6, 2021</span></span>

### <a name="categories"></a><span data-ttu-id="d6824-433">Kategorie</span><span class="sxs-lookup"><span data-stu-id="d6824-433">Categories</span></span>

- <span data-ttu-id="d6824-434">Datum: 4. 5. 2021</span><span class="sxs-lookup"><span data-stu-id="d6824-434">Date: 2021-05-04</span></span>

- <span data-ttu-id="d6824-435">Možnosti</span><span class="sxs-lookup"><span data-stu-id="d6824-435">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="d6824-436">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="d6824-436">Impacted audience</span></span>

<span data-ttu-id="d6824-437">Partneři, kteří prodávají nabídky Academic, Nonprofit a Government Community Cloud (GCC) prostřednictvím Cloud Solution Provider prostřednictvím rozhraní Partnerské centrum API</span><span class="sxs-lookup"><span data-stu-id="d6824-437">Partners selling Academic, Nonprofit, and Government Community Cloud (GCC) offers through the Cloud Solution Provider program using the Partner Center API</span></span>

### <a name="details"></a><span data-ttu-id="d6824-438">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="d6824-438">Details</span></span>

<span data-ttu-id="d6824-439">Toto oznámení následuje po vylepšeních Partnerské centrum [vydaných v prosinci](./2020-december.md#1).</span><span class="sxs-lookup"><span data-stu-id="d6824-439">This announcement is a follow-up to the Partner Center [enhancements released in December](./2020-december.md#1).</span></span> <span data-ttu-id="d6824-440">V rámci této verze se nasadila nová rozhraní API pro kvalifikace GET a POST a v důsledku toho se stávající kvalifikace **GET 6. května 2021 vyřazena.**</span><span class="sxs-lookup"><span data-stu-id="d6824-440">As part of that release, new GET and POST Qualifications APIs were deployed and, as a result, **the existing GET qualification will be retired on May 6, 2021**.</span></span> <span data-ttu-id="d6824-441">Do té doby budete muset přejít na používání nových rozhraní POST API Partnerské centrum.</span><span class="sxs-lookup"><span data-stu-id="d6824-441">By that time, you will need to have transitioned to using the new POST Partner Center APIs.</span></span> <span data-ttu-id="d6824-442">Nová rozhraní POST API vám umožní zakoupit nabídky pro vzdělávání, zatímco nová rozhraní GET API vám umožní nakupovat předem kvalifikované nabídky Pro neziskové organizace a GCC.</span><span class="sxs-lookup"><span data-stu-id="d6824-442">The new POST APIs will enable you to purchase Education offers, while the new GET APIs will enable you to purchase pre-qualified Nonprofit and GCC offers.</span></span>

### <a name="next-steps"></a><span data-ttu-id="d6824-443">Další kroky</span><span class="sxs-lookup"><span data-stu-id="d6824-443">Next steps</span></span>

- <span data-ttu-id="d6824-444">Pokud chcete zajistit úspěšný a **včasný přechod,** aktualizujte na nová rozhraní API.</span><span class="sxs-lookup"><span data-stu-id="d6824-444">**Update to the new APIs** for a successful and timely transition.</span></span>

- <span data-ttu-id="d6824-445">**Projděte si nové změny Partnerské centrum API** a průvodce v nárocích k provozní připravenosti: vylepšení procesu ověřování zákazníků Partnerské centrum education pro [zákazníky.](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)</span><span class="sxs-lookup"><span data-stu-id="d6824-445">**Review the new Partner Center API changes and Guide** in the Operations Readiness resources: [Partner Center Education customer validation process enhancements](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/).</span></span>

- <span data-ttu-id="d6824-446">Tyto informace můžete sdílet s příslušnými týmy ve vaší organizaci a s prodejci, aby se na tyto změny připravili.</span><span class="sxs-lookup"><span data-stu-id="d6824-446">Share this information with the appropriate teams within your organization and with your resellers to help them prepare for these changes.</span></span>

### <a name="questions"></a><span data-ttu-id="d6824-447">Máte otázky?</span><span class="sxs-lookup"><span data-stu-id="d6824-447">Questions?</span></span>

<span data-ttu-id="d6824-448">Pokud máte dotazy související s tímto oznámením, [kontaktujte Partnerské centrum podporu.](https://partner.microsoft.com/dashboard/support/referrals/servicerequests?category=referrals)</span><span class="sxs-lookup"><span data-stu-id="d6824-448">For any questions related to this notification, contact [Partner Center support](https://partner.microsoft.com/dashboard/support/referrals/servicerequests?category=referrals).</span></span>

### <a name="change-log"></a><span data-ttu-id="d6824-449">Protokol změn</span><span class="sxs-lookup"><span data-stu-id="d6824-449">Change log</span></span>

- <span data-ttu-id="d6824-450">4. května 2021: Závěrečné připomenutí nadcházejícího vyněcování kvalifikace GET</span><span class="sxs-lookup"><span data-stu-id="d6824-450">May 4, 2021: Final reminder of upcoming deprecation of GET qualification</span></span>

- <span data-ttu-id="d6824-451">9. dubna 2021: Připomenutí nadcházejícího vyněcování kvalifikace GET</span><span class="sxs-lookup"><span data-stu-id="d6824-451">April 9, 2021: Reminder of upcoming deprecation of GET qualification</span></span> 

- <span data-ttu-id="d6824-452">Únor: Aktualizace časových os pro vyněcování kvalifikace GET & PUT</span><span class="sxs-lookup"><span data-stu-id="d6824-452">February: Updated timelines for deprecation of GET & PUT qualifications</span></span>

- <span data-ttu-id="d6824-453">Leden: Připomenutí nadcházejícího vynětu kvalifikace GET & PUT</span><span class="sxs-lookup"><span data-stu-id="d6824-453">January: Reminder of upcoming deprecations of GET & PUT qualifications</span></span>

________________
## <a name="corrections-to-may-1-2021-license-based-services-price-list"></a><a name="3"></a><span data-ttu-id="d6824-454">Oprava ceníku licenčních služeb k 1. květnu 2021</span><span class="sxs-lookup"><span data-stu-id="d6824-454">Corrections to May 1, 2021 License-based services price list</span></span>

### <a name="categories"></a><span data-ttu-id="d6824-455">Kategorie</span><span class="sxs-lookup"><span data-stu-id="d6824-455">Categories</span></span>

- <span data-ttu-id="d6824-456">Datum: 4. 5. 2021</span><span class="sxs-lookup"><span data-stu-id="d6824-456">Date: 2021-05-04</span></span>

- <span data-ttu-id="d6824-457">Nabídky/trhy</span><span class="sxs-lookup"><span data-stu-id="d6824-457">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="d6824-458">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="d6824-458">Impacted audience</span></span>

<span data-ttu-id="d6824-459">Nepřímí poskytovatelé a partneři s přímým vyúčtováním, kteří provádí transakce se službami založenými na licencích Cloud Solution Provider programu.</span><span class="sxs-lookup"><span data-stu-id="d6824-459">Indirect providers and direct bill partners transacting license-based services in the Cloud Solution Provider program.</span></span>

### <a name="details"></a><span data-ttu-id="d6824-460">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="d6824-460">Details</span></span>

<span data-ttu-id="d6824-461">Ceník služeb založených na licencích zveřejněný 1. května 2021 obsahoval nesprávnou cenu za USD pro Microsoft 365 Business Standard.</span><span class="sxs-lookup"><span data-stu-id="d6824-461">The price list for license-based services posted on May 1, 2021 included an incorrect price for USD for Microsoft 365 Business Standard.</span></span> <span data-ttu-id="d6824-462">Publikovaná listová cena byla 8 USD, kdy měla být 10 USD.</span><span class="sxs-lookup"><span data-stu-id="d6824-462">The List Price published was $8, when it should have been $10.</span></span> <span data-ttu-id="d6824-463">Ceník služeb na základě licencí se aktualizoval 3. března 2021 v 11:30 PST s opravami.</span><span class="sxs-lookup"><span data-stu-id="d6824-463">The license-based services price list was updated on March 3, 2021 at 11:30am PST with the corrections.</span></span> <span data-ttu-id="d6824-464">Tyto opravy se vztahují pouze na:</span><span class="sxs-lookup"><span data-stu-id="d6824-464">These corrections were only applicable to:</span></span>

- <span data-ttu-id="d6824-465">Název nabídky: Microsoft 365 Business Standard</span><span class="sxs-lookup"><span data-stu-id="d6824-465">Offer Name: Microsoft 365 Business Standard</span></span>

- <span data-ttu-id="d6824-466">ID nabídky: 031c9e47-4802-4248-838e-778fb1d2cc05</span><span class="sxs-lookup"><span data-stu-id="d6824-466">Offer ID: 031c9e47-4802-4248-838e-778fb1d2cc05</span></span>

- <span data-ttu-id="d6824-467">Měny: USD</span><span class="sxs-lookup"><span data-stu-id="d6824-467">Currencies: USD</span></span>

- <span data-ttu-id="d6824-468">Před: List Price (Ceníková cena): 8 USD</span><span class="sxs-lookup"><span data-stu-id="d6824-468">Before: List Price: $8</span></span>

- <span data-ttu-id="d6824-469">Po: List Price (Ceníková cena): 10 USD</span><span class="sxs-lookup"><span data-stu-id="d6824-469">After: List Price: $10</span></span>

<span data-ttu-id="d6824-470">Tyto změny se vztahují pouze na výše uvedenou nabídku.</span><span class="sxs-lookup"><span data-stu-id="d6824-470">These changes only apply to the above offer.</span></span> <span data-ttu-id="d6824-471">Jiné nabídky se netýkaly žádných oprav.</span><span class="sxs-lookup"><span data-stu-id="d6824-471">Other offers had no corrections.</span></span> <span data-ttu-id="d6824-472">Jedná se pouze o chybu ceníku, nikoli o skutečnou cenovou chybu, která bude mít vliv na fakturaci během této doby.</span><span class="sxs-lookup"><span data-stu-id="d6824-472">This was a Price List error only, not an actual price error that will affect invoicing during this time.</span></span>

### <a name="next-steps-and-resources"></a><span data-ttu-id="d6824-473">Další kroky a zdroje informací</span><span class="sxs-lookup"><span data-stu-id="d6824-473">Next steps and resources</span></span>

- <span data-ttu-id="d6824-474">Partneři, kteří provádí transakce se službami založenými na licencích, by si měli stáhnout nejnovější ceník.</span><span class="sxs-lookup"><span data-stu-id="d6824-474">Partners who transact license-based services should download the latest price list.</span></span>

________________
## <a name="announcement-of-state-owned-entity-qualification"></a><a name="2"></a><span data-ttu-id="d6824-475">Oznámení kvalifikace vlastněné státem</span><span class="sxs-lookup"><span data-stu-id="d6824-475">Announcement of State Owned Entity qualification</span></span>

### <a name="categories"></a><span data-ttu-id="d6824-476">Kategorie</span><span class="sxs-lookup"><span data-stu-id="d6824-476">Categories</span></span>

- <span data-ttu-id="d6824-477">Datum: 4. 5. 2021</span><span class="sxs-lookup"><span data-stu-id="d6824-477">Date: 2021-05-04</span></span>
- <span data-ttu-id="d6824-478">Možnosti</span><span class="sxs-lookup"><span data-stu-id="d6824-478">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="d6824-479">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="d6824-479">Impacted audience</span></span>

<span data-ttu-id="d6824-480">Všichni partneři CSP (Cloud Solution Partner), kteří se prodávají specializovaným odvětvím</span><span class="sxs-lookup"><span data-stu-id="d6824-480">All Cloud Solution Partner (CSP) partners selling to specialized industries</span></span>

### <a name="details"></a><span data-ttu-id="d6824-481">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="d6824-481">Details</span></span>

<span data-ttu-id="d6824-482">V rámci našeho závazku pomáhat partnerům a zákazníkům s provozem jejich podnikání na základě důvěry budeme 7. května zvát partnery po celém světě, aby deklarovali, jestli mají zákazníky, kteří mají nárok na entitu vlastněnou státem.</span><span class="sxs-lookup"><span data-stu-id="d6824-482">As part of our commitment to help partners and customers run their business based on trust, on May 7 we’ll be inviting partners worldwide to declare whether they have customers that qualify as a State Owned Entity.</span></span> <span data-ttu-id="d6824-483">Další informace o způsobilosti najdete v tématu Kritéria entit [vlastněných státem | Etické & dodržování předpisů](https://www.microsoft.com/legal/compliance/anticorruption/criteria).</span><span class="sxs-lookup"><span data-stu-id="d6824-483">To learn more about eligibility, see [State Owned Entity Criteria | Ethics & Compliance](https://www.microsoft.com/legal/compliance/anticorruption/criteria).</span></span> <span data-ttu-id="d6824-484">Partneři mohou při vytváření nového zákazníka deklarovat své zákazníky jako entitu vlastněnou státem prostřednictvím speciální možnosti kvalifikace.</span><span class="sxs-lookup"><span data-stu-id="d6824-484">Partners can declare their customers as State Owned Entity via the special qualifications option when creating a new customer.</span></span>

<span data-ttu-id="d6824-485">Ukázku rozhraní API najdete v tématu Asynchronní získání [kvalifikace zákazníka.](/partner-center/develop/get-customer-qualification-asynchronous)</span><span class="sxs-lookup"><span data-stu-id="d6824-485">For an API sample, see [Get a customer's qualification asynchronously](/partner-center/develop/get-customer-qualification-asynchronous).</span></span>

### <a name="next-steps"></a><span data-ttu-id="d6824-486">Další kroky</span><span class="sxs-lookup"><span data-stu-id="d6824-486">Next steps</span></span>

<span data-ttu-id="d6824-487">Zkontrolujte [kritéria způsobilosti](https://www.microsoft.com/legal/compliance/anticorruption/criteria).</span><span class="sxs-lookup"><span data-stu-id="d6824-487">Review the [eligibility criteria](https://www.microsoft.com/legal/compliance/anticorruption/criteria).</span></span>

________________
## <a name="view-this-months-product-launches-and-offers"></a><a name="1"></a><span data-ttu-id="d6824-488">Zobrazení nabídek a uvedení produktů pro tento měsíc na trh</span><span class="sxs-lookup"><span data-stu-id="d6824-488">View this month’s product launches and offers</span></span>

### <a name="categories"></a><span data-ttu-id="d6824-489">Kategorie</span><span class="sxs-lookup"><span data-stu-id="d6824-489">Categories</span></span>

- <span data-ttu-id="d6824-490">Datum: 3. 5. 2021, aktualizováno 7. 5. 2021</span><span class="sxs-lookup"><span data-stu-id="d6824-490">Date: 2021-05-03, updated 2021-05-07</span></span>
- <span data-ttu-id="d6824-491">Nabídky | Business Applications</span><span class="sxs-lookup"><span data-stu-id="d6824-491">Offers | Business Applications</span></span>

### <a name="summary"></a><span data-ttu-id="d6824-492">Souhrn</span><span class="sxs-lookup"><span data-stu-id="d6824-492">Summary</span></span>

<span data-ttu-id="d6824-493">Kalendář pro uvedení produktu [](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) na trh z května 2021 je teď publikovaný.</span><span class="sxs-lookup"><span data-stu-id="d6824-493">The May 2021 [product launch calendar](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) is now published.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="d6824-494">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="d6824-494">Impacted audience</span></span>

<span data-ttu-id="d6824-495">Všichni partneři, kteří provádí transakce prostřednictvím Cloud Solution Provider (CSP)</span><span class="sxs-lookup"><span data-stu-id="d6824-495">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="d6824-496">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="d6824-496">Details</span></span>

<span data-ttu-id="d6824-497">Kalendář spuštění produktu z [](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) května 2021 je nyní k dispozici v galerii prostředků provozní připravenosti.</span><span class="sxs-lookup"><span data-stu-id="d6824-497">The May 2021 [product launch calendar](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) is now available in the Operations readiness resource gallery.</span></span> <span data-ttu-id="d6824-498">Nadcházející uvedení produktů a nabídek si můžete prohlédnout tady.</span><span class="sxs-lookup"><span data-stu-id="d6824-498">View the upcoming product launches and offers here.</span></span>

### <a name="next-steps"></a><span data-ttu-id="d6824-499">Další kroky</span><span class="sxs-lookup"><span data-stu-id="d6824-499">Next steps</span></span>

<span data-ttu-id="d6824-500">Zkontrolujte kalendář [spuštění produktu a](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) podělte se o informace s příslušnými účastníky ve vaší organizaci.</span><span class="sxs-lookup"><span data-stu-id="d6824-500">Review the [product launch calendar](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) and share the information with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="d6824-501">Máte otázky?</span><span class="sxs-lookup"><span data-stu-id="d6824-501">Questions?</span></span>

<span data-ttu-id="d6824-502">Další otázky týkající se těchto nabídek najdete v příslušných komunitách Yammeru.</span><span class="sxs-lookup"><span data-stu-id="d6824-502">For any further questions about these offers, check your relevant Yammer communities.</span></span>