...
### <a name="impacted-audience"></a><span data-ttu-id="be66f-110">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="be66f-110">Impacted audience</span></span>
...
<span data-ttu-id="be66f-123">**Centrum pro správu Microsoft 365**</span><span class="sxs-lookup"><span data-stu-id="be66f-123">**Microsoft 365 Admin Center**</span></span>
...
- <span data-ttu-id="be66f-134">30. září 2020: původní publikace</span><span class="sxs-lookup"><span data-stu-id="be66f-134">September 30, 2020: Original publication</span></span> 
...
### <a name="change-log"></a><span data-ttu-id="be66f-157">Protokol změn:</span><span class="sxs-lookup"><span data-stu-id="be66f-157">Change Log:</span></span>
...
### <a name="categories"></a><span data-ttu-id="be66f-184">Kategorie</span><span class="sxs-lookup"><span data-stu-id="be66f-184">Categories</span></span>
...
### <a name="testing"></a><span data-ttu-id="be66f-197">Testování</span><span class="sxs-lookup"><span data-stu-id="be66f-197">Testing</span></span> 
...
## <a name="next-steps"></a><span data-ttu-id="be66f-210">Další kroky</span><span class="sxs-lookup"><span data-stu-id="be66f-210">Next steps</span></span>
...
- <span data-ttu-id="be66f-219">Datum: 2020-09-29</span><span class="sxs-lookup"><span data-stu-id="be66f-219">Date: 2020-09-29</span></span>
...
### <a name="summary"></a><span data-ttu-id="be66f-253">Souhrn</span><span class="sxs-lookup"><span data-stu-id="be66f-253">Summary</span></span> 
...
### <a name="next-steps"></a><span data-ttu-id="be66f-264">Další kroky:</span><span class="sxs-lookup"><span data-stu-id="be66f-264">Next Steps:</span></span>
...
<span data-ttu-id="be66f-279">**MyInsights** už nebude k dispozici po 30. září 2020.</span><span class="sxs-lookup"><span data-stu-id="be66f-279">**MyInsights** will no longer be available after September 30, 2020.</span></span> 
...
- <span data-ttu-id="be66f-290">Doporučujeme vám, abyste tyto nové funkce prozkoumali a nasdíleli svůj názor pomocí nástrojů pro vkládání názorů, které jsou dostupné na kartě přehledy.</span><span class="sxs-lookup"><span data-stu-id="be66f-290">We encourage you to explore these new capabilities and share your feedback using the inline feedback tools available in the Insights tab.</span></span>
...
- <span data-ttu-id="be66f-303">Aktualizuje podporované typy operací pro záznam auditu.</span><span class="sxs-lookup"><span data-stu-id="be66f-303">Update supported operation types for Audit Record.</span></span> <span data-ttu-id="be66f-304">Nově přidaná jsou uvedena na stránce [auditování prostředků](/partner-center/develop/auditing-resources) .</span><span class="sxs-lookup"><span data-stu-id="be66f-304">The newly added ones are listed at [Auditing resources](/partner-center/develop/auditing-resources)</span></span>
...
- <span data-ttu-id="be66f-321">Datum: 2020-09-22</span><span class="sxs-lookup"><span data-stu-id="be66f-321">Date: 2020-09-22</span></span>
...
### <a name="next-stepsadditional-resources"></a><span data-ttu-id="be66f-334">Další kroky/další zdroje informací:</span><span class="sxs-lookup"><span data-stu-id="be66f-334">Next Steps/Additional Resources:</span></span>
...
### <a name="details"></a><span data-ttu-id="be66f-345">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="be66f-345">Details</span></span>
...
<span data-ttu-id="be66f-370">Činností</span><span class="sxs-lookup"><span data-stu-id="be66f-370">Actions:</span></span>
...
<span data-ttu-id="be66f-381">Činností</span><span class="sxs-lookup"><span data-stu-id="be66f-381">Actions:</span></span>
...
#### <a name="mpa-reporting-in-partner-center"></a><span data-ttu-id="be66f-394">Generování sestav technologie MPA v partnerském centru</span><span class="sxs-lookup"><span data-stu-id="be66f-394">MPA reporting in Partner Center</span></span>
...
### <a name="details"></a><span data-ttu-id="be66f-406">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="be66f-406">Details</span></span>
...
<span data-ttu-id="be66f-411">Poznámka: možnosti nákupu samoobslužných služeb nejsou aktuálně k dispozici v Indii, Brazílii, demokratické republice Kongo (Konžská demokratická republika) nebo zákazníkům, kteří mají nárok na nabídky pro státní správu a vzdělávání.</span><span class="sxs-lookup"><span data-stu-id="be66f-411">Note:  Self-service purchase capabilities aren’t currently available in India, Brazil, Democratic Republic of Congo (DRC), or to customers who are eligible for Government or Education offers.</span></span>  <span data-ttu-id="be66f-412">Projděte si [Nejčastější dotazy k nákupu samoobslužných služeb](/microsoft-365/commerce/subscriptions/self-service-purchase-faq?preserve-view=true&view=o365-worldwide) pro celou zemi a dostupnost aktualizací.</span><span class="sxs-lookup"><span data-stu-id="be66f-412">Check the [self-service purchase FAQ](/microsoft-365/commerce/subscriptions/self-service-purchase-faq?preserve-view=true&view=o365-worldwide) for full country availability and updates.</span></span>

#### <a name="partner-benefits"></a><span data-ttu-id="be66f-413">Výhody pro partnery</span><span class="sxs-lookup"><span data-stu-id="be66f-413">Partner benefits</span></span>

<span data-ttu-id="be66f-414">Vaše služby budete moct nabízet jednotlivcům a týmům, aniž byste museli projít centralizovaným procesem pro nákup IT, abyste získali požadované licence.</span><span class="sxs-lookup"><span data-stu-id="be66f-414">You’ll be able to offer your services to individuals and teams without needing to go through a centralized IT procurement process to obtain required licenses.</span></span> <span data-ttu-id="be66f-415">Vaše služby můžou na základě scénářů integrace s Microsoft 365 a Power platformou vycházet z projektu a Visia.</span><span class="sxs-lookup"><span data-stu-id="be66f-415">Your services can span Project and Visio, based on integration scenarios with Microsoft 365 and Power Platform.</span></span> <span data-ttu-id="be66f-416">Zákazníci si také můžou vyzkoušet před nákupem s zkušebními verzemi aplikace Visio a projektu, k dispozici nyní pro [aplikace Visio Plan 1 a Visio Plan 2](https://partner.microsoft.com/resources/collection/visio-availability-announcing-trial-offers#/)a [Project Plan 1](https://www.microsoft.com/microsoft-365/project/compare-microsoft-project-management-software).</span><span class="sxs-lookup"><span data-stu-id="be66f-416">Customers can also try before they buy with Visio and Project trials, available now for [Visio Plan 1 and Visio Plan 2](https://partner.microsoft.com/resources/collection/visio-availability-announcing-trial-offers#/), and [Project Plan 1](https://www.microsoft.com/microsoft-365/project/compare-microsoft-project-management-software).</span></span>


### <a name="next-steps"></a><span data-ttu-id="be66f-417">Další kroky</span><span class="sxs-lookup"><span data-stu-id="be66f-417">Next steps</span></span>

- <span data-ttu-id="be66f-418">Projděte si všechny prostředky připravenosti v galerii prostředků připravenosti na provoz: [možnosti nákupu samoobslužných](https://partner.microsoft.com/resources/collection/customer-self-serve-purchase#/)uživatelů.</span><span class="sxs-lookup"><span data-stu-id="be66f-418">Review all readiness resources in the Operations Readiness resources gallery: [Customer self-serve purchase capability](https://partner.microsoft.com/resources/collection/customer-self-serve-purchase#/).</span></span> <span data-ttu-id="be66f-419">– Přečtěte si další informace o možnostech partnerů pomocí řešení pro aplikace Visio a Power Platform v rámci [opětovného sestavování a představování obchodních aplikací pomocí Microsoft Visia a Power Platform](https://www.microsoft.com/microsoft-365/partners/videos/inspire-visio-power-platform).</span><span class="sxs-lookup"><span data-stu-id="be66f-419">-Learn more about partner opportunities with Visio and Power Platform solutions in the Microsoft Inspire session [Rebuild and reimagine business with Microsoft Visio and Power Platform](https://www.microsoft.com/microsoft-365/partners/videos/inspire-visio-power-platform).</span></span>
- <span data-ttu-id="be66f-420">Další informace najdete v [příručce pro správce samoobslužných služeb](/microsoft-365/commerce/subscriptions/manage-self-service-purchases-admins?preserve-view=true&view=o365-worldwide) .</span><span class="sxs-lookup"><span data-stu-id="be66f-420">Refer to the [self-service admin guide](/microsoft-365/commerce/subscriptions/manage-self-service-purchases-admins?preserve-view=true&view=o365-worldwide) for additional information.</span></span>

________________

## <a name="new-skus-bring-the-power-of-project-cortex-and-more-to-customers"></a><a name="5"></a><span data-ttu-id="be66f-421">Nové SKU přinesou výkon projektu Cortex a další zákazníkům.</span><span class="sxs-lookup"><span data-stu-id="be66f-421">New SKUs bring the power of Project Cortex and more to customers</span></span>

### <a name="categories"></a><span data-ttu-id="be66f-422">Kategorie</span><span class="sxs-lookup"><span data-stu-id="be66f-422">Categories</span></span>

- <span data-ttu-id="be66f-423">Datum: 2020-09-08</span><span class="sxs-lookup"><span data-stu-id="be66f-423">Date: 2020-09-08</span></span>
- <span data-ttu-id="be66f-424">Nabídky/trhy</span><span class="sxs-lookup"><span data-stu-id="be66f-424">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="be66f-425">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="be66f-425">Impacted audience</span></span>

<span data-ttu-id="be66f-426">Všechny partnery, kteří se docházejí prostřednictvím programu Cloud Solution Provider (CSP)</span><span class="sxs-lookup"><span data-stu-id="be66f-426">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="summary"></a><span data-ttu-id="be66f-427">Souhrn</span><span class="sxs-lookup"><span data-stu-id="be66f-427">Summary</span></span>

<span data-ttu-id="be66f-428">Nové skladové jednotky, které zákazníkům pomohou využít sílu [projektu Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) a [projekt Turing](https://msturing.org/) , budou k dispozici pro Transact od 1. října 2020.</span><span class="sxs-lookup"><span data-stu-id="be66f-428">New SKUs to help customers harness the power of [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) and [Project Turing](https://msturing.org/) will be available to transact from October 1, 2020.</span></span>

### <a name="details"></a><span data-ttu-id="be66f-429">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="be66f-429">Details</span></span>

<span data-ttu-id="be66f-430">S radostí oznamujeme od 1. října 2020 dostupnost nových SKU, včetně [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) (Intelligent Content Services) a služby Microsoft Search (včetně konektorů Microsoft Graph pro hledání), které umožní uživatelům rychleji vyhledávat a spravovat informace.</span><span class="sxs-lookup"><span data-stu-id="be66f-430">We’re excited to announce the October 1, 2020 availability of new SKUs including [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) (Intelligent Content Services) and Microsoft Search (including Microsoft Graph Connectors for Search) that will enable users to find and manage information more efficiently.</span></span>  

#### <a name="intelligent-content-services"></a><span data-ttu-id="be66f-431">Inteligentní služby obsahu</span><span class="sxs-lookup"><span data-stu-id="be66f-431">Intelligent Content Services</span></span>
  
<span data-ttu-id="be66f-432">Služba Intelligent Content Services využívá rozšířené AI k automatizaci zachytávání, označování a správy obsahu.</span><span class="sxs-lookup"><span data-stu-id="be66f-432">Intelligent Content Services uses advanced AI to automate the capture, tagging, and management of content.</span></span> <span data-ttu-id="be66f-433">Vytváří na SharePointu pro zpracování obsahu s velkým objemem, extrahuje metadata pro automatizaci procesů a jemně odstupňované zabezpečení a dodržování předpisů.</span><span class="sxs-lookup"><span data-stu-id="be66f-433">It builds on SharePoint for high-volume content processing, extracting metadata for process automation, and fine-grained security and compliance.</span></span> <span data-ttu-id="be66f-434">Služba inteligentního obsahu vylepšuje znalosti a zjišťování znalostí tím, že do vaší znalostní sítě dorazí přes přesnější a přesný obsah.</span><span class="sxs-lookup"><span data-stu-id="be66f-434">Intelligent content services improve knowledge curation and discovery experiences by pushing more accurate and precise content into your knowledge network.</span></span> <span data-ttu-id="be66f-435">Nové skladové položky inteligentních služeb obsahu budou dostupné v ceníku **1. října** (a 1. září Preview ceníku).</span><span class="sxs-lookup"><span data-stu-id="be66f-435">New Intelligent Content Services SKUs will be available on the **October 1 price list** (and on the September 1 price list preview).</span></span> 
 
<span data-ttu-id="be66f-436">**Poznámka:** Inteligentní služby obsahu jsou zástupný symbol pro tento produkt, který bude pravděpodobně po 1. říjnu 2020 nahrazen.</span><span class="sxs-lookup"><span data-stu-id="be66f-436">**Note:** Intelligent Content Services is a placeholder name for this product, which is likely to be rebranded after October 1, 2020.</span></span>
 
<span data-ttu-id="be66f-437">**Konektory Microsoft Graph pro Microsoft Search** Konektory Microsoft Graph umožňují zákazníkům indexovat položky v externích úložištích pro zařazení do výsledků hledání ve společnosti Microsoft.</span><span class="sxs-lookup"><span data-stu-id="be66f-437">**Microsoft Graph connectors for Microsoft Search** Microsoft Graph connectors enable customers to index items in external repositories for inclusion in Microsoft Search results.</span></span> 

<span data-ttu-id="be66f-438">Od 1. října 2020:</span><span class="sxs-lookup"><span data-stu-id="be66f-438">From October 1, 2020:</span></span> 

- <span data-ttu-id="be66f-439">Microsoft 365 E5 a Office 365 E5 budou zahrnovat možnost indexování až 500 položek pomocí Microsoft Graph konektorů pro Microsoft Search (nezahrnuje a5).</span><span class="sxs-lookup"><span data-stu-id="be66f-439">Microsoft 365 E5 and Office 365 E5 will include the ability to index up to 500 items using Microsoft Graph connectors for Microsoft Search (not included with A5).</span></span>  
- <span data-ttu-id="be66f-440">Každý uživatel se sadou nebo samostatnou licencí, která zahrnuje plán SharePointu nebo OneDrive, bude moct zobrazit výsledky hledání z Microsoft Graphových konektorů pro Microsoft Search.</span><span class="sxs-lookup"><span data-stu-id="be66f-440">Any user with a suite or standalone license that includes a SharePoint or OneDrive plan will be able to see search results from Microsoft Graph connectors for Microsoft Search.</span></span> 
- <span data-ttu-id="be66f-441">Pro indexování až 1 000 000 dalších položek bude k dispozici nová **SKU kapacity konektoru grafu** .</span><span class="sxs-lookup"><span data-stu-id="be66f-441">A new **Extra Graph Connector Capacity SKU** will be available for indexing up to 1 million additional items.</span></span>  

#### <a name="offer-details"></a><span data-ttu-id="be66f-442">Podrobnosti nabídky</span><span class="sxs-lookup"><span data-stu-id="be66f-442">Offer details</span></span>

   |<span data-ttu-id="be66f-443">**Název nabídky**</span><span class="sxs-lookup"><span data-stu-id="be66f-443">**Offer name**</span></span>|<span data-ttu-id="be66f-444">**ID nabídky**</span><span class="sxs-lookup"><span data-stu-id="be66f-444">**Offer ID**</span></span>|<span data-ttu-id="be66f-445">**ID materiálu**</span><span class="sxs-lookup"><span data-stu-id="be66f-445">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="be66f-446">Inteligentní služby obsahu</span><span class="sxs-lookup"><span data-stu-id="be66f-446">Intelligent Content Services</span></span>|<span data-ttu-id="be66f-447">2e969027-6eca-44a3-88fb-e7923e2c147f</span><span class="sxs-lookup"><span data-stu-id="be66f-447">2e969027-6eca-44a3-88fb-e7923e2c147f</span></span>|<span data-ttu-id="be66f-448">5YI-00004</span><span class="sxs-lookup"><span data-stu-id="be66f-448">5YI-00004</span></span>|
   |<span data-ttu-id="be66f-449">Inteligentní služby obsahu (ceny neziskových zaměstnanců)</span><span class="sxs-lookup"><span data-stu-id="be66f-449">Intelligent Content Services (Nonprofit Staff Pricing)</span></span>|<span data-ttu-id="be66f-450">48db24e2-0aac-47bd-bd74-40bde9ff7748</span><span class="sxs-lookup"><span data-stu-id="be66f-450">48db24e2-0aac-47bd-bd74-40bde9ff7748</span></span>|<span data-ttu-id="be66f-451">5YI-00005</span><span class="sxs-lookup"><span data-stu-id="be66f-451">5YI-00005</span></span>|
   |<span data-ttu-id="be66f-452">Inteligentní služby obsahu pro vyučující</span><span class="sxs-lookup"><span data-stu-id="be66f-452">Intelligent Content Services for faculty</span></span>|<span data-ttu-id="be66f-453">4a8f9036-791e-4ce4-a788-6c5af859fd82</span><span class="sxs-lookup"><span data-stu-id="be66f-453">4a8f9036-791e-4ce4-a788-6c5af859fd82</span></span>|<span data-ttu-id="be66f-454">5Z1-00005</span><span class="sxs-lookup"><span data-stu-id="be66f-454">5Z1-00005</span></span>|
   |<span data-ttu-id="be66f-455">Kapacita extra spojnice grafu</span><span class="sxs-lookup"><span data-stu-id="be66f-455">Extra Graph Connector Capacity</span></span>|<span data-ttu-id="be66f-456">9c8b008f-d84f-46cd-a588-fea84947161d</span><span class="sxs-lookup"><span data-stu-id="be66f-456">9c8b008f-d84f-46cd-a588-fea84947161d</span></span>|<span data-ttu-id="be66f-457">1LA-00002</span><span class="sxs-lookup"><span data-stu-id="be66f-457">1LA-00002</span></span>|
   |<span data-ttu-id="be66f-458">Dodatečná kapacita konektoru grafu pro vyučující</span><span class="sxs-lookup"><span data-stu-id="be66f-458">Extra Graph Connector Capacity for faculty</span></span>|<span data-ttu-id="be66f-459">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span><span class="sxs-lookup"><span data-stu-id="be66f-459">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span></span>|<span data-ttu-id="be66f-460">1TL-00003</span><span class="sxs-lookup"><span data-stu-id="be66f-460">1TL-00003</span></span>|

### <a name="next-steps"></a><span data-ttu-id="be66f-461">Další kroky</span><span class="sxs-lookup"><span data-stu-id="be66f-461">Next steps</span></span>

- <span data-ttu-id="be66f-462">Projděte si materiály k tomuto tématu a sdílejte je s příslušnými zúčastněnými stranami ve vaší organizaci.</span><span class="sxs-lookup"><span data-stu-id="be66f-462">Review the resources for this topic and share them with the appropriate stakeholders in your organization.</span></span>
- <span data-ttu-id="be66f-463">Pokud máte nějaké dotazy týkající se těchto nabídek, Projděte si příslušné komunity Yammeru.</span><span class="sxs-lookup"><span data-stu-id="be66f-463">If you have any questions about these offers, check your relevant Yammer communities.</span></span>

________________

## <a name="enhanced-incentives-support-experience-and-ticket-creation-process"></a><a name="4"></a><span data-ttu-id="be66f-464">Vylepšení možností podpory a procesu vytváření lístků</span><span class="sxs-lookup"><span data-stu-id="be66f-464">Enhanced Incentives support experience and ticket creation process</span></span>

### <a name="categories"></a><span data-ttu-id="be66f-465">Kategorie</span><span class="sxs-lookup"><span data-stu-id="be66f-465">Categories</span></span>

- <span data-ttu-id="be66f-466">Datum: 2020-09-02</span><span class="sxs-lookup"><span data-stu-id="be66f-466">Date: 2020-09-02</span></span>
- <span data-ttu-id="be66f-467">Možnosti</span><span class="sxs-lookup"><span data-stu-id="be66f-467">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="be66f-468">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="be66f-468">Impacted audience</span></span>

<span data-ttu-id="be66f-469">Všichni partneři</span><span class="sxs-lookup"><span data-stu-id="be66f-469">All partners</span></span>

### <a name="summary"></a><span data-ttu-id="be66f-470">Souhrn</span><span class="sxs-lookup"><span data-stu-id="be66f-470">Summary</span></span>

<span data-ttu-id="be66f-471">Prostředí podpory pro partnery je vylepšené a vylepšili jsme tak vylepšení obsahu samoobslužné pomoci a zjednodušeného procesu odesílání online lístků.</span><span class="sxs-lookup"><span data-stu-id="be66f-471">The Partner Incentives support experience has been enhanced with improved self-help content discoverability and a streamlined online ticket submission process.</span></span>

### <a name="details"></a><span data-ttu-id="be66f-472">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="be66f-472">Details</span></span>

<span data-ttu-id="be66f-473">Přidali jsme vylepšení pro partnerské pobídky, která zlepšují vaše celkové prostředí podpory prostřednictvím lepšího zjistitelného obsahu a zjednodušeného procesu odesílání lístků, který během procesu podpory omezuje shromažďování dat zpět.</span><span class="sxs-lookup"><span data-stu-id="be66f-473">Enhancements have been added for Partner Incentives to improve your overall support experience through better self-help content discoverability and a streamlined ticket submission process that reduces back-and-forth data collection during the support process.</span></span>

#### <a name="new-capabilities"></a><span data-ttu-id="be66f-474">Nové funkce</span><span class="sxs-lookup"><span data-stu-id="be66f-474">New capabilities</span></span>

- <span data-ttu-id="be66f-475">Nové prostředí pro samoobslužnou nápovědu založené na vyhledávání je dostupné v rámci [partnerského centra](https://aka.ms/IncentivesSupport) a na [Microsoft Partner Network](https://partner.microsoft.com/support/?stage=1) pro účty mimo partnerských Center.</span><span class="sxs-lookup"><span data-stu-id="be66f-475">New search-based self-help experience is accessible within [Partner Center](https://aka.ms/IncentivesSupport) and on [Microsoft Partner Network](https://partner.microsoft.com/support/?stage=1) for non-Partner Center accounts.</span></span> <span data-ttu-id="be66f-476">Nové prostředí obsahuje nové kroky pro řešení potíží, nejčastější dotazy a odkazy na relevantní články pro samoobslužnou pomoc i na stránce podpory Microsoft Partner Network.</span><span class="sxs-lookup"><span data-stu-id="be66f-476">The new experience includes new troubleshooting steps, FAQs, and links to relevant self-help articles as well as on the Microsoft Partner Network Support page.</span></span>
- <span data-ttu-id="be66f-477">Novou žádost o podporu Iniciujte přímo v partnerském centru.</span><span class="sxs-lookup"><span data-stu-id="be66f-477">Initiate a new support request directly in Partner Center.</span></span> <span data-ttu-id="be66f-478">Pokud stále potřebujete pomoc, můžete si po zobrazení dostupné nápovědy pro témata vytvořit jenom lístek přímo z partnerského centra.</span><span class="sxs-lookup"><span data-stu-id="be66f-478">After viewing the available topic-specific help, if you still need assistance, you can only create a ticket directly from Partner Center.</span></span>
- <span data-ttu-id="be66f-479">Nový problém – otázky týkající se rozsahu jsou k dispozici pro každé téma samoobslužné nápovědy.</span><span class="sxs-lookup"><span data-stu-id="be66f-479">New problem-scoping questions are available for every self-help topic.</span></span> <span data-ttu-id="be66f-480">Po dokončení těchto otázek se na začátku lístku podpory sníží velká část back-end, a to tak, že agentovi poskytne spoustu důležitých podrobností.</span><span class="sxs-lookup"><span data-stu-id="be66f-480">Completing these questions reduces much of the back-and-forth at the beginning of the support ticket by providing the agent with many of the important details up front.</span></span>


### <a name="next-steps"></a><span data-ttu-id="be66f-481">Další kroky</span><span class="sxs-lookup"><span data-stu-id="be66f-481">Next steps</span></span>

- <span data-ttu-id="be66f-482">Tyto informace budete sdílet s ostatními uživateli ve vaší organizaci.</span><span class="sxs-lookup"><span data-stu-id="be66f-482">Share this information with others in your organization.</span></span> 
- <span data-ttu-id="be66f-483">Využijte nové prostředí pro podporu prostřednictvím [partnerského centra](https://aka.ms/IncentivesSupport) nebo na [Microsoft Partner Network](https://partner.microsoft.com/support/?stage=1) pro všechny vaše požadavky na podporu vašich pobídek.</span><span class="sxs-lookup"><span data-stu-id="be66f-483">Use the new support experience via [Partner Center](https://aka.ms/IncentivesSupport) or on [Microsoft Partner Network](https://partner.microsoft.com/support/?stage=1) for all your Incentives support requirements.</span></span> 

<span data-ttu-id="be66f-484">**Poznámka:** Žádosti o podporu nebudou přijímány prostřednictvím přímého e-mailu, protože tato funkce je vyřazená.</span><span class="sxs-lookup"><span data-stu-id="be66f-484">**Note:** Support requests will not be accepted through direct email, as this function is retired.</span></span>

________________

## <a name="upcoming-new-microsoft-dynamics-365-offers"></a><a name="3"></a><span data-ttu-id="be66f-485">Nadcházející nové nabídky Microsoft Dynamics 365</span><span class="sxs-lookup"><span data-stu-id="be66f-485">Upcoming new Microsoft Dynamics 365 offers</span></span>

### <a name="categories"></a><span data-ttu-id="be66f-486">Kategorie</span><span class="sxs-lookup"><span data-stu-id="be66f-486">Categories</span></span>

- <span data-ttu-id="be66f-487">Datum: 2020-09-01</span><span class="sxs-lookup"><span data-stu-id="be66f-487">Date: 2020-09-01</span></span>
- <span data-ttu-id="be66f-488">Nabídky/trhy</span><span class="sxs-lookup"><span data-stu-id="be66f-488">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="be66f-489">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="be66f-489">Impacted audience</span></span>

<span data-ttu-id="be66f-490">Partneři s podporou řešení Microsoft Dynamics 365</span><span class="sxs-lookup"><span data-stu-id="be66f-490">Partners transacting Microsoft Dynamics 365</span></span>

### <a name="summary"></a><span data-ttu-id="be66f-491">Souhrn</span><span class="sxs-lookup"><span data-stu-id="be66f-491">Summary</span></span>

<span data-ttu-id="be66f-492">Nadcházející nabídky pro zákazníky s Microsoft Dynamics 365 zahrnují vydání operací Microsoft Projectu a další prostředí pro firmy Business Central.</span><span class="sxs-lookup"><span data-stu-id="be66f-492">Upcoming offers for Microsoft Dynamics 365 customers include the release of Microsoft Project Operations, and additional environments for Business Central.</span></span>

### <a name="details"></a><span data-ttu-id="be66f-493">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="be66f-493">Details</span></span>

<span data-ttu-id="be66f-494">Od 1. října 2020 budou k dispozici následující nové nabídky.</span><span class="sxs-lookup"><span data-stu-id="be66f-494">The following new offers will be available on October 1, 2020.</span></span>

#### <a name="project-operations"></a><span data-ttu-id="be66f-495">Project Operations</span><span class="sxs-lookup"><span data-stu-id="be66f-495">Project Operations</span></span>

<span data-ttu-id="be66f-496">Od 1. října 2020 bude společnost Microsoft vydávat nabídky operací s produktem Dynamics 365 a z programu Cloud Solution Provider (CSP) odebrat Dynamics 365 Project Service Automation (PSA).</span><span class="sxs-lookup"><span data-stu-id="be66f-496">On October 1, 2020, Microsoft will release Dynamics 365 Project Operations offers and remove Dynamics 365 Project Service Automation (PSA) for the Cloud Solution Provider (CSP) program.</span></span> <span data-ttu-id="be66f-497">Noví zákazníci musí koupit operace projektu Dynamics 365.</span><span class="sxs-lookup"><span data-stu-id="be66f-497">New customers must purchase Dynamics 365 Project Operations.</span></span> 

<span data-ttu-id="be66f-498">Existující zákazníky Dynamics 365 s PSA:</span><span class="sxs-lookup"><span data-stu-id="be66f-498">For existing Dynamics 365 customers with PSA:</span></span>

- <span data-ttu-id="be66f-499">Pokračujte v používání sady Dynamics 365 PSA až do 1. října 2020 nebo do konce poslední smlouvy nebo obnovení, podle toho, co nastane dřív.</span><span class="sxs-lookup"><span data-stu-id="be66f-499">Continue to use Dynamics 365 PSA until October 1, 2020, or until the end of their most recent contract or renewal, whichever occurs first.</span></span>
- <span data-ttu-id="be66f-500">Dynamics 365 PSA se po dobu jednoho roku od 1. října 2021 ve zprostředkovateli kryptografických služeb spustí znovu, dokud 1. října 2022.</span><span class="sxs-lookup"><span data-stu-id="be66f-500">Dynamics 365 PSA will autorenew for one year until October 1, 2021 in CSP, allowing contracts to continue until October 1, 2022.</span></span>
- <span data-ttu-id="be66f-501">Licence na Dynamics 365 PSA automaticky obdrží projektové operace v rámci svých aktuálních licencí do 31. prosince 2020.</span><span class="sxs-lookup"><span data-stu-id="be66f-501">Dynamics 365 PSA licenses will automatically receive Project Operations as part of their current licenses by December 31, 2020.</span></span>
- <span data-ttu-id="be66f-502">Na konci smluv Dynamics 365 PSA musí zákazníci přejít k projektovým operacím, což bude mít nulový minimální SKU přechodu PSA pro uživatele.</span><span class="sxs-lookup"><span data-stu-id="be66f-502">At the end of Dynamics 365 PSA contracts, customers need to transition to Project Operations, which will have a zero user minimum PSA transition SKU.</span></span>

<span data-ttu-id="be66f-503">Podrobnosti o ID nabídky najdete v [dokumentu Dynamics CSP Offers-October 2020 Excelu v dokumentu aplikace](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) Project – karta operace projektu.</span><span class="sxs-lookup"><span data-stu-id="be66f-503">Review the Project Operations tab in the [Dynamics CSP Offers-October 2020 Excel document](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) for the offer ID details.</span></span>

#### <a name="additional-resources"></a><span data-ttu-id="be66f-504">Další zdroje informací</span><span class="sxs-lookup"><span data-stu-id="be66f-504">Additional resources</span></span>

- <span data-ttu-id="be66f-505">[Přechod prostředků](https://partner.microsoft.com/asset/collection/psa-transition-resources#/) pro psa</span><span class="sxs-lookup"><span data-stu-id="be66f-505">[Transition resources](https://partner.microsoft.com/asset/collection/psa-transition-resources#/) for PSA</span></span>
- <span data-ttu-id="be66f-506">[Představení blogu služby Project Automation pro Microsoft Dynamics 365](https://cloudblogs.microsoft.com/dynamics365/bdm/2020/02/20/introducing-microsoft-dynamics-365-project-operations/)</span><span class="sxs-lookup"><span data-stu-id="be66f-506">[Introducing Microsoft Dynamics 365 Project Service Automation](https://cloudblogs.microsoft.com/dynamics365/bdm/2020/02/20/introducing-microsoft-dynamics-365-project-operations/) blog</span></span>
- <span data-ttu-id="be66f-507">[Co se chystá v školicím materiálu pro automatizaci služby projektu Microsoft Dynamics 365](https://assetsprod.microsoft.com/mpn/what-is-coming-in-d365-project-service-automation-dyn767pal.pdf)</span><span class="sxs-lookup"><span data-stu-id="be66f-507">[What is coming in Microsoft Dynamics 365 Project Service Automation](https://assetsprod.microsoft.com/mpn/what-is-coming-in-d365-project-service-automation-dyn767pal.pdf) training material</span></span>

#### <a name="expansion-of-business-central-offers-into-additional-countries"></a><span data-ttu-id="be66f-508">Rozšiřování obchodních ústředních nabídek do dalších zemí</span><span class="sxs-lookup"><span data-stu-id="be66f-508">Expansion of Business Central offers into additional countries</span></span>

<span data-ttu-id="be66f-509">Od 1. října 2020 Microsoft rozšiřuje obchodní centrální Cloud nabídky na Brazílie, Irsko, Lotyšsko, Faerské ostrovy a Grónsko.</span><span class="sxs-lookup"><span data-stu-id="be66f-509">On October 1, 2020, Microsoft is expanding Business Central Cloud offers into Brazil, Ireland, Lithuania, the Faroe Islands, and Greenland.</span></span>

#### <a name="business-central-additional-environments"></a><span data-ttu-id="be66f-510">Další prostředí Business Central</span><span class="sxs-lookup"><span data-stu-id="be66f-510">Business Central additional environments</span></span>

<span data-ttu-id="be66f-511">Od 1. října 2020 budou k dispozici nové nabídky doplňků pro podnikové centrální cloudové nabídky, aby zákazníci mohli přidávat další prostředí.</span><span class="sxs-lookup"><span data-stu-id="be66f-511">On October 1, 2020, new add-on offers for Business Central Cloud offers will be available to enable customers to add extra environments.</span></span> 

<span data-ttu-id="be66f-512">Podívejte se na kartu **Další prostředí** v [dokumentu Dynamics CSP Offers-October 2020 Excel](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) pro podrobnosti ID nabídky.</span><span class="sxs-lookup"><span data-stu-id="be66f-512">Review the **Additional Environments** tab in the [Dynamics CSP Offers-October 2020 Excel document](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) for the offer ID details.</span></span>

### <a name="next-steps"></a><span data-ttu-id="be66f-513">Další kroky</span><span class="sxs-lookup"><span data-stu-id="be66f-513">Next steps</span></span>

<span data-ttu-id="be66f-514">Tuto aktualizaci nasdílejte s příslušnými kontakty ve vaší organizaci.</span><span class="sxs-lookup"><span data-stu-id="be66f-514">Share this update with the relevant contacts in your organization.</span></span>

________________

## <a name="office-365-calling-plan-will-be-available-in-new-markets-on-october-1-2020"></a><a name="2"></a><span data-ttu-id="be66f-515">Plán volání Office 365 bude k dispozici na nových trzích od 1. října 2020</span><span class="sxs-lookup"><span data-stu-id="be66f-515">Office 365 Calling Plan will be available in new markets on October 1, 2020</span></span>

### <a name="categories"></a><span data-ttu-id="be66f-516">Kategorie</span><span class="sxs-lookup"><span data-stu-id="be66f-516">Categories</span></span>

- <span data-ttu-id="be66f-517">Datum: 2020-09-01</span><span class="sxs-lookup"><span data-stu-id="be66f-517">Date: 2020-09-01</span></span>
- <span data-ttu-id="be66f-518">Nabídky/trhy</span><span class="sxs-lookup"><span data-stu-id="be66f-518">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="be66f-519">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="be66f-519">Impacted audience</span></span>

<span data-ttu-id="be66f-520">Partneři poskytovatele Cloud Solution Provider (CSP), včetně přímých zprostředkovatelů, nepřímých poskytovatelů a nepřímých prodejců</span><span class="sxs-lookup"><span data-stu-id="be66f-520">Cloud Solution Provider (CSP) partners, including direct providers, indirect providers, and indirect resellers</span></span>

### <a name="summary"></a><span data-ttu-id="be66f-521">Souhrn</span><span class="sxs-lookup"><span data-stu-id="be66f-521">Summary</span></span>

<span data-ttu-id="be66f-522">Společnost Microsoft se zajímá, že volající plán bude k dispozici na následujících nových trzích od 1. října 2020: Rakouska, Dánska, Itálie, Portugalska, Švédska a Švýcarska.</span><span class="sxs-lookup"><span data-stu-id="be66f-522">Microsoft is excited to announce that Calling Plan will be available in the following new markets on October 1, 2020: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span> 

### <a name="details"></a><span data-ttu-id="be66f-523">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="be66f-523">Details</span></span>

<span data-ttu-id="be66f-524">Microsoft 365 plán volání bude k dispozici na následujících nových trzích od 1. října 2020: Rakousko, Dánsko, Itálie, Portugalsko, Švédsko a Švýcarsko.</span><span class="sxs-lookup"><span data-stu-id="be66f-524">Microsoft 365 Calling Plan will be available in the following new markets on October 1, 2020: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span> <span data-ttu-id="be66f-525">Nová geografická dostupnost se spustí v rámci komerčního, celosvětového cloudového sektoru, neziskového a oficiálního cloudu prostřednictvím smlouva Enterprise (EA) nebo smlouva Enterprise předplatné (EAS), registrace řešení pro vzdělávání (EES), webového Direct a CSP.</span><span class="sxs-lookup"><span data-stu-id="be66f-525">The new geo availability will launch in Commercial, Worldwide Public Sector, Nonprofit, and Government Community Cloud via Enterprise Agreement (EA) or Enterprise Agreement Subscription (EAS), Enrollment for Education Solutions (EES), Web Direct, and CSP.</span></span> 

<span data-ttu-id="be66f-526">Všechny funkce pro volání plánu budou k dispozici pro tuzemské a mezinárodní volající plány, včetně 120, 240 a 1 200 minut za uživatele za měsíc (p/s/m) domácích plánů a mezinárodní plán se 1 200 domácí minuty p/u/m a 600 mezinárodní minuty p/u/m.</span><span class="sxs-lookup"><span data-stu-id="be66f-526">All Calling Plan features will be available for Microsoft’s Domestic and International Calling Plans, including the 120, 240, and 1,200 minutes per user per month (p/u/m) Domestic plans, and the International Plan with 1,200 domestic minutes p/u/m and 600 international minutes p/u/m.</span></span> 

<span data-ttu-id="be66f-527">Přečtěte si další podrobnosti o volání plánů, nadměrném využití a úvěrových kreditech v části věnovaném voláním v tématu [Nejčastější dotazy k licencování pro moderní práci](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements).</span><span class="sxs-lookup"><span data-stu-id="be66f-527">Find additional details for Calling Plans, excessive usage, and communications credits in the Calling Plan section of the [Modern Work Licensing FAQ](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements).</span></span>

<span data-ttu-id="be66f-528">Plán volání je aktuálně k dispozici v Belgii, Kanadě, Francii, Německu, Irsku, Nizozemsku (dostupnosti kanálu je omezené jenom na EA a EES), Španělsku, Spojeném království a USA (dostupnost plánu volání třetí strany v Austrálii a Japonsku).</span><span class="sxs-lookup"><span data-stu-id="be66f-528">Calling Plan is currently available in Belgium, Canada, France, Germany, Ireland, Netherlands, Puerto Rico (channel availability limited to EA and EES only), Spain, the United Kingdom, and the United States (third-party Calling Plan availability in Australia and Japan).</span></span>

#### <a name="offer-details"></a><span data-ttu-id="be66f-529">Podrobnosti nabídky</span><span class="sxs-lookup"><span data-stu-id="be66f-529">Offer details</span></span>

   |<span data-ttu-id="be66f-530">**Název nabídky**</span><span class="sxs-lookup"><span data-stu-id="be66f-530">**Offer name**</span></span>|<span data-ttu-id="be66f-531">**ID nabídky**</span><span class="sxs-lookup"><span data-stu-id="be66f-531">**Offer ID**</span></span>|<span data-ttu-id="be66f-532">**ID materiálu**</span><span class="sxs-lookup"><span data-stu-id="be66f-532">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="be66f-533">Microsoft 365 vnitrostátního volání plánu</span><span class="sxs-lookup"><span data-stu-id="be66f-533">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="be66f-534">52b01454-aa44-4e03-8049-c4d57496a430</span><span class="sxs-lookup"><span data-stu-id="be66f-534">52b01454-aa44-4e03-8049-c4d57496a430</span></span>|<span data-ttu-id="be66f-535">4ID-00002</span><span class="sxs-lookup"><span data-stu-id="be66f-535">4ID-00002</span></span>|
   |<span data-ttu-id="be66f-536">Microsoft 365 vnitrostátního volání plánu</span><span class="sxs-lookup"><span data-stu-id="be66f-536">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="be66f-537">0f598efe-f330-4d79-b79f-c9480bb7ce3e</span><span class="sxs-lookup"><span data-stu-id="be66f-537">0f598efe-f330-4d79-b79f-c9480bb7ce3e</span></span>|<span data-ttu-id="be66f-538">AAA-13706</span><span class="sxs-lookup"><span data-stu-id="be66f-538">AAA-13706</span></span>|
   |<span data-ttu-id="be66f-539">Microsoft 365 vnitrostátního volání plánu (ceny pro státní správu)</span><span class="sxs-lookup"><span data-stu-id="be66f-539">Microsoft 365 Domestic Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="be66f-540">96b96fd8-b77d-41a4-ae5d-0a6652f454b7</span><span class="sxs-lookup"><span data-stu-id="be66f-540">96b96fd8-b77d-41a4-ae5d-0a6652f454b7</span></span>|<span data-ttu-id="be66f-541">AAA-13707</span><span class="sxs-lookup"><span data-stu-id="be66f-541">AAA-13707</span></span>|
   |<span data-ttu-id="be66f-542">Microsoft 365 plán domácího volání pro studenty</span><span class="sxs-lookup"><span data-stu-id="be66f-542">Microsoft 365 Domestic Calling Plan for students</span></span>|<span data-ttu-id="be66f-543">da2034e1-c147-4aae-afab-9c15acf16ea5</span><span class="sxs-lookup"><span data-stu-id="be66f-543">da2034e1-c147-4aae-afab-9c15acf16ea5</span></span>|<span data-ttu-id="be66f-544">AAA-22335</span><span class="sxs-lookup"><span data-stu-id="be66f-544">AAA-22335</span></span>|
   |<span data-ttu-id="be66f-545">Microsoft 365 vnitrostátního volání plánu pro vyučujícího</span><span class="sxs-lookup"><span data-stu-id="be66f-545">Microsoft 365 Domestic Calling Plan for faculty</span></span>|<span data-ttu-id="be66f-546">5e8853ed-611c-4f9c-af21-540ba351a636</span><span class="sxs-lookup"><span data-stu-id="be66f-546">5e8853ed-611c-4f9c-af21-540ba351a636</span></span>|<span data-ttu-id="be66f-547">AAA-22334</span><span class="sxs-lookup"><span data-stu-id="be66f-547">AAA-22334</span></span>|
   |<span data-ttu-id="be66f-548">Microsoft 365 vnitrostátním voláním plánu pro RSZ</span><span class="sxs-lookup"><span data-stu-id="be66f-548">Microsoft 365 Domestic Calling Plan for GCC</span></span>|<span data-ttu-id="be66f-549">7099743e-f474-48be-97bc-d4fb22f059bf</span><span class="sxs-lookup"><span data-stu-id="be66f-549">7099743e-f474-48be-97bc-d4fb22f059bf</span></span>|<span data-ttu-id="be66f-550">AAD-25690</span><span class="sxs-lookup"><span data-stu-id="be66f-550">AAD-25690</span></span>|
   |<span data-ttu-id="be66f-551">Microsoft 365 vnitrostátní a mezinárodní volající plán</span><span class="sxs-lookup"><span data-stu-id="be66f-551">Microsoft 365 Domestic and International Calling Plan</span></span>|<span data-ttu-id="be66f-552">ded34535-507f-4246-8370-f9180318c537</span><span class="sxs-lookup"><span data-stu-id="be66f-552">ded34535-507f-4246-8370-f9180318c537</span></span>|<span data-ttu-id="be66f-553">AAA-13708</span><span class="sxs-lookup"><span data-stu-id="be66f-553">AAA-13708</span></span>|
   |<span data-ttu-id="be66f-554">Microsoft 365 vnitrostátním a mezinárodním voláním plánu (ceny pro státní správu)</span><span class="sxs-lookup"><span data-stu-id="be66f-554">Microsoft 365 Domestic and International Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="be66f-555">d97b23b4-627c-41db-8f55-ce342b0db656</span><span class="sxs-lookup"><span data-stu-id="be66f-555">d97b23b4-627c-41db-8f55-ce342b0db656</span></span>|<span data-ttu-id="be66f-556">AAA-13709</span><span class="sxs-lookup"><span data-stu-id="be66f-556">AAA-13709</span></span>|
   |<span data-ttu-id="be66f-557">Microsoft 365 vnitrostátní a mezinárodní volající plán pro studenty</span><span class="sxs-lookup"><span data-stu-id="be66f-557">Microsoft 365 Domestic and International Calling Plan for students</span></span>|<span data-ttu-id="be66f-558">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span><span class="sxs-lookup"><span data-stu-id="be66f-558">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span></span>|<span data-ttu-id="be66f-559">AAA-22337</span><span class="sxs-lookup"><span data-stu-id="be66f-559">AAA-22337</span></span>|
   |<span data-ttu-id="be66f-560">Microsoft 365 domácí a mezinárodní volající plán pro vyučující</span><span class="sxs-lookup"><span data-stu-id="be66f-560">Microsoft 365 Domestic and International Calling Plan for faculty</span></span>|<span data-ttu-id="be66f-561">492b8a14-381c-4536-bf63-bd5785c14734</span><span class="sxs-lookup"><span data-stu-id="be66f-561">492b8a14-381c-4536-bf63-bd5785c14734</span></span>|<span data-ttu-id="be66f-562">AAA-22336</span><span class="sxs-lookup"><span data-stu-id="be66f-562">AAA-22336</span></span>|
   |<span data-ttu-id="be66f-563">Microsoft 365 vnitrostátní a mezinárodní volající plán pro RSZ</span><span class="sxs-lookup"><span data-stu-id="be66f-563">Microsoft 365 Domestic and International Calling Plan for GCC</span></span>|<span data-ttu-id="be66f-564">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span><span class="sxs-lookup"><span data-stu-id="be66f-564">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span></span>|<span data-ttu-id="be66f-565">AAD-25680</span><span class="sxs-lookup"><span data-stu-id="be66f-565">AAD-25680</span></span>|
   |<span data-ttu-id="be66f-566">Microsoft 365 vnitrostátního volání plánu (120 min.)</span><span class="sxs-lookup"><span data-stu-id="be66f-566">Microsoft 365 Domestic Calling Plan (120 min)</span></span>|<span data-ttu-id="be66f-567">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span><span class="sxs-lookup"><span data-stu-id="be66f-567">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span></span>|<span data-ttu-id="be66f-568">AAD-11639</span><span class="sxs-lookup"><span data-stu-id="be66f-568">AAD-11639</span></span>|
   |<span data-ttu-id="be66f-569">Microsoft 365 vnitrostátního volání plánu (120 min) pro studenty</span><span class="sxs-lookup"><span data-stu-id="be66f-569">Microsoft 365 Domestic Calling Plan (120 min) for students</span></span>|<span data-ttu-id="be66f-570">353d7f89-2e6f-4deb-9145-80f281a782ab</span><span class="sxs-lookup"><span data-stu-id="be66f-570">353d7f89-2e6f-4deb-9145-80f281a782ab</span></span>|<span data-ttu-id="be66f-571">AAD-11641</span><span class="sxs-lookup"><span data-stu-id="be66f-571">AAD-11641</span></span>|
   |<span data-ttu-id="be66f-572">Microsoft 365 vnitrostátního volání plánu (120 min) pro vyučující</span><span class="sxs-lookup"><span data-stu-id="be66f-572">Microsoft 365 Domestic Calling Plan (120 min) for faculty</span></span>|<span data-ttu-id="be66f-573">80fc6c74-cc94-478d-97b0-8455593a5987</span><span class="sxs-lookup"><span data-stu-id="be66f-573">80fc6c74-cc94-478d-97b0-8455593a5987</span></span>|<span data-ttu-id="be66f-574">AAD-11640</span><span class="sxs-lookup"><span data-stu-id="be66f-574">AAD-11640</span></span>|

### <a name="next-steps"></a><span data-ttu-id="be66f-575">Další kroky</span><span class="sxs-lookup"><span data-stu-id="be66f-575">Next steps</span></span>

<span data-ttu-id="be66f-576">Projděte si materiály k tomuto tématu a sdílejte tyto informace s příslušnými zúčastněnými stranami ve vaší organizaci.</span><span class="sxs-lookup"><span data-stu-id="be66f-576">Review the resources about this topic, and share this information with the appropriate stakeholders in your organization.</span></span>

________________

## <a name="microsoft-defender-advanced-threat-protection-atp-for-servers-for-education-is-now-available"></a><a name="1"></a><span data-ttu-id="be66f-577">Pro servery pro vzdělávání je teď k dispozici rozšířená ochrana před internetovými útoky (ATP) v programu Microsoft Defender.</span><span class="sxs-lookup"><span data-stu-id="be66f-577">Microsoft Defender Advanced Threat Protection (ATP) for Servers for Education is now available</span></span>

### <a name="categories"></a><span data-ttu-id="be66f-578">Kategorie</span><span class="sxs-lookup"><span data-stu-id="be66f-578">Categories</span></span>

- <span data-ttu-id="be66f-579">Datum: 2020-09-01</span><span class="sxs-lookup"><span data-stu-id="be66f-579">Date: 2020-09-01</span></span>
- <span data-ttu-id="be66f-580">Nabídky/trhy</span><span class="sxs-lookup"><span data-stu-id="be66f-580">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="be66f-581">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="be66f-581">Impacted audience</span></span>

<span data-ttu-id="be66f-582">Všichni partneři účastnící se programu CSP</span><span class="sxs-lookup"><span data-stu-id="be66f-582">All partners participating in the CSP program</span></span> 

### <a name="details"></a><span data-ttu-id="be66f-583">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="be66f-583">Details</span></span>

<span data-ttu-id="be66f-584">Pro servery pro vzdělávání je teď k dispozici rozšířená ochrana před internetovými útoky v programu Microsoft Defender (ATP) od 1. září 2020 v programu Cloud Solution Provider (CSP).</span><span class="sxs-lookup"><span data-stu-id="be66f-584">Microsoft Defender Advanced Threat Protection (ATP) for Servers for Education is now available, as of September 1, 2020 in the Cloud Solution Provider (CSP) program.</span></span>  
<span data-ttu-id="be66f-585">Podrobnosti o nabídce produktů:</span><span class="sxs-lookup"><span data-stu-id="be66f-585">Product Offer Details:</span></span>

- <span data-ttu-id="be66f-586">Název nabídky: ATP programu Microsoft Defender pro servery pro vzdělávání</span><span class="sxs-lookup"><span data-stu-id="be66f-586">Offer name: Microsoft Defender ATP for Servers for Education</span></span>
- <span data-ttu-id="be66f-587">ID nabídky: c7b9ab7e-8f80-4b4b-8aed-dcad61f2899</span><span class="sxs-lookup"><span data-stu-id="be66f-587">Offer ID: c7b9ab7e-8f80-4b4b-8aed-dcad61f2899</span></span>

### <a name="next-steps"></a><span data-ttu-id="be66f-588">Další kroky</span><span class="sxs-lookup"><span data-stu-id="be66f-588">Next steps</span></span>

- <span data-ttu-id="be66f-589">Tyto informace sdílejte s příslušnými kontakty ve vaší organizaci.</span><span class="sxs-lookup"><span data-stu-id="be66f-589">Share this information with the appropriate contacts in your organization.</span></span>
- <span data-ttu-id="be66f-590">Další informace o produktu najdete v [dokumentaci ke službě Microsoft Defender ATP](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) .</span><span class="sxs-lookup"><span data-stu-id="be66f-590">Read the [Microsoft Defender ATP documentation](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) for more information about the product.</span></span>
