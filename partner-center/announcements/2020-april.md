...
### <a name="summary"></a><span data-ttu-id="9ef9e-112">Souhrn</span><span class="sxs-lookup"><span data-stu-id="9ef9e-112">Summary</span></span>
...
### <a name="questions"></a><span data-ttu-id="9ef9e-137">Máte otázky?</span><span class="sxs-lookup"><span data-stu-id="9ef9e-137">Questions?</span></span>
...
## <a name="microsoft-reversed-the-csp-eur-price-for-microsoft-365-e3"></a><a id="12"/></a><span data-ttu-id="9ef9e-160">Microsoft obrátí cenu CSP EUR za Microsoft 365 E3.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-160">Microsoft reversed the CSP EUR price for Microsoft 365 E3.</span></span>
...
- <span data-ttu-id="9ef9e-185">Datum: 2020-04-23</span><span class="sxs-lookup"><span data-stu-id="9ef9e-185">Date: 2020-04-23</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="9ef9e-201">Další kroky</span><span class="sxs-lookup"><span data-stu-id="9ef9e-201">Next steps</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="9ef9e-228">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="9ef9e-228">Impacted audience</span></span>
...
- <span data-ttu-id="9ef9e-244">Krok 1: v levém navigačním panelu vyberte podpora a vytvořte žádost o podporu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-244">Step 1: From the left-hand navigation, select Support and create a support request</span></span>
...
### <a name="summary"></a><span data-ttu-id="9ef9e-256">Souhrn</span><span class="sxs-lookup"><span data-stu-id="9ef9e-256">Summary</span></span>
...
### <a name="additional-resources"></a><span data-ttu-id="9ef9e-278">Další materiály</span><span class="sxs-lookup"><span data-stu-id="9ef9e-278">Additional resources</span></span>
...
### <a name="summary"></a><span data-ttu-id="9ef9e-292">Souhrn</span><span class="sxs-lookup"><span data-stu-id="9ef9e-292">Summary</span></span>
...
<span data-ttu-id="9ef9e-323">Všichni partneři procházejí prostřednictvím poskytovatele Cloud Solution po celém světě.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-323">All partners transacting through the Cloud Solution Provider worldwide.</span></span>
...
<span data-ttu-id="9ef9e-434">Partneři, kteří nabízejí Dynamics 365, prostřednictvím programu Cloud Solution Provider (CSP).</span><span class="sxs-lookup"><span data-stu-id="9ef9e-434">Partners offering Dynamics 365 through the Cloud Solution Provider (CSP) program.</span></span> <span data-ttu-id="9ef9e-435">Tyto aktualizace se vztahují na všechny lokality po celém světě, pokud není uvedeno jinak.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-435">These updates relate to all locations worldwide, unless otherwise specified.</span></span>

### <a name="details"></a><span data-ttu-id="9ef9e-436">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="9ef9e-436">Details</span></span>

<span data-ttu-id="9ef9e-437">Od 1. dubna 2020 společnost Microsoft vydala nové produkty pro Dynamics Business Central online a aplikace Dynamics kancelářské a platformy Power Platform.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-437">On April 1, 2020, Microsoft released new products for Dynamics Business Central Online, and Dynamics Biz Apps and Power Platforms.</span></span> <span data-ttu-id="9ef9e-438">Další nové nabídky pro Dynamics 365 budou vydány 1. května 2020.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-438">Additional new offers for Dynamics 365 will be released on May 1, 2020.</span></span>

### <a name="dynamics-business-central-online-offers"></a><span data-ttu-id="9ef9e-439">Dynamics Business Central – online nabídky</span><span class="sxs-lookup"><span data-stu-id="9ef9e-439">Dynamics Business Central Online Offers</span></span>
<span data-ttu-id="9ef9e-440">Od 1. dubna 2020 byly provedeny následující změny v nabídkách Dynamics Business Central online.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-440">On April 1, 2020, the following changes were made to the Dynamics Business Central Online offers.</span></span>

- <span data-ttu-id="9ef9e-441">Nové nabídky Dynamics Business v nástroji CSP pro firmy Business Central</span><span class="sxs-lookup"><span data-stu-id="9ef9e-441">New Dynamics Business offers for Business Central in CSP</span></span>
- <span data-ttu-id="9ef9e-442">Aktualizace SKU Sales pro a Customer Service pro připojení SKU</span><span class="sxs-lookup"><span data-stu-id="9ef9e-442">Update Sales Pro and Customer Service Pro Attach SKUs</span></span>

### <a name="dynamics-biz-apps-and-power-platform-products"></a><span data-ttu-id="9ef9e-443">Aplikace Dynamics a produkty Power Platform</span><span class="sxs-lookup"><span data-stu-id="9ef9e-443">Dynamics Biz Apps and Power Platform Products</span></span>

<span data-ttu-id="9ef9e-444">Od 1. dubna 2020 byly provedeny následující změny aplikací Dynamics a produktů Power Platform.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-444">On April 1, 2020, the following changes were made to the Dynamics Biz Apps and Power Platform products.</span></span>

- <span data-ttu-id="9ef9e-445">Nabídky služby automatizace automatizovaných procesů (RPA) první strany</span><span class="sxs-lookup"><span data-stu-id="9ef9e-445">First-party Robotic Process Automation (RPA) offers</span></span>
- <span data-ttu-id="9ef9e-446">Nový produkt BOT pro nabídky RPA</span><span class="sxs-lookup"><span data-stu-id="9ef9e-446">New BOT product for RPA offers</span></span>

<span data-ttu-id="9ef9e-447">V [tomto](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)tématu se podívejte na konkrétní změny v nabídce Dynamics CSP nabídky Updates-Mar 2020.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-447">Please see the specific changes in the Dynamics CSP Offer Updates-Mar 2020 file [here](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/).</span></span>

### <a name="robotic-process-automation"></a><span data-ttu-id="9ef9e-448">Automatizace automatických procesů</span><span class="sxs-lookup"><span data-stu-id="9ef9e-448">Robotic Process Automation</span></span>

<span data-ttu-id="9ef9e-449">Od 1. května 2020 bude společnost Microsoft rozšiřovat dostupnost nových nabídek RPA do vzdělávacích programů.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-449">On May 1, 2020, Microsoft will be expanding the availability of new RPA offers into the Education programs.</span></span>
<span data-ttu-id="9ef9e-450">Další informace o změnách v programu pro autorizovaný vzdělávací partner v CSP získáte kliknutím [sem](https://partner.microsoft.com/resources/collection/csp-aer-partner-qualification-retirement#/).</span><span class="sxs-lookup"><span data-stu-id="9ef9e-450">To learn more about changes to the Authorized Education Partner Program in CSP click [here](https://partner.microsoft.com/resources/collection/csp-aer-partner-qualification-retirement#/).</span></span> <span data-ttu-id="9ef9e-451">Toto je odkaz na existující kolekci v partnerském centru.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-451">This is a link to an existing collection on Partner Center).</span></span>

<span data-ttu-id="9ef9e-452">Informace o nových informacích o SKU najdete v přiložené **nabídce Dynamics CSP Updates-May souboru 2020** [v části](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/) související ke stažení.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-452">Please review the attached **Dynamics CSP Offer Updates-May 2020 file** [here](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/) in the related download section for new SKU information.</span></span>

### <a name="ecommerce-changes"></a><span data-ttu-id="9ef9e-453">Elektronického obchodování změny</span><span class="sxs-lookup"><span data-stu-id="9ef9e-453">eCommerce changes</span></span>

<span data-ttu-id="9ef9e-454">Od 1. dubna 2020 mají nabídky elektronického obchodování název a/nebo PFAM změny za poslední cenové listy.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-454">Effective April 1, 2020, eCommerce offers have display name and/or PFAM changes on the final price sheets.</span></span> <span data-ttu-id="9ef9e-455">Změny jsou popsány v následující tabulce.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-455">The changes are outlined in the table below.</span></span>

|<span data-ttu-id="9ef9e-456">**Zobrazované jméno nebo PFAM změna**</span><span class="sxs-lookup"><span data-stu-id="9ef9e-456">**Display Name and/or PFAM Change**</span></span>|<span data-ttu-id="9ef9e-457">**1. března 2020**</span><span class="sxs-lookup"><span data-stu-id="9ef9e-457">**March 1, 2020**</span></span>|<span data-ttu-id="9ef9e-458">**1. dubna 2020**</span><span class="sxs-lookup"><span data-stu-id="9ef9e-458">**April 1, 2020**</span></span>|
|-------------------|:------|:-----|
|<span data-ttu-id="9ef9e-459">Zobrazovaný název</span><span class="sxs-lookup"><span data-stu-id="9ef9e-459">Display Name</span></span>|<span data-ttu-id="9ef9e-460">Elektronického obchodování hodnocení a recenze</span><span class="sxs-lookup"><span data-stu-id="9ef9e-460">eCommerce Ratings and Reviews</span></span>|<span data-ttu-id="9ef9e-461">Hodnocení a recenze pro obchod</span><span class="sxs-lookup"><span data-stu-id="9ef9e-461">Commerce Ratings and Reviews</span></span>|
|<span data-ttu-id="9ef9e-462">Zobrazovaný název</span><span class="sxs-lookup"><span data-stu-id="9ef9e-462">Display Name</span></span>|<span data-ttu-id="9ef9e-463">Doporučení pro elektronického obchodování</span><span class="sxs-lookup"><span data-stu-id="9ef9e-463">eCommerce Recommendations</span></span>|<span data-ttu-id="9ef9e-464">Doporučení pro obchod</span><span class="sxs-lookup"><span data-stu-id="9ef9e-464">Commerce Recommendations</span></span>|
|<span data-ttu-id="9ef9e-465">Zobrazit a PFAM</span><span class="sxs-lookup"><span data-stu-id="9ef9e-465">Display and PFAM</span></span>|<span data-ttu-id="9ef9e-466">Dynamics 365 Commerce Cloud Scale jednotka úrovně Basic</span><span class="sxs-lookup"><span data-stu-id="9ef9e-466">Dynamics 365 Commerce Cloud Scale Unit Basic</span></span>|<span data-ttu-id="9ef9e-467">Dynamics 365 Commerce Scale Unit úrovně Basic – Cloud</span><span class="sxs-lookup"><span data-stu-id="9ef9e-467">Dynamics 365 Commerce Scale Unit Basic – Cloud</span></span>|
|<span data-ttu-id="9ef9e-468">Zobrazit a PFAM</span><span class="sxs-lookup"><span data-stu-id="9ef9e-468">Display and PFAM</span></span>|<span data-ttu-id="9ef9e-469">Dynamics 365 Commerce Cloud Scale jednotka Standard</span><span class="sxs-lookup"><span data-stu-id="9ef9e-469">Dynamics 365 Commerce Cloud Scale Unit Standard</span></span>|<span data-ttu-id="9ef9e-470">Dynamics 365 Commerce Scale Unit úrovně Basic-Cloud</span><span class="sxs-lookup"><span data-stu-id="9ef9e-470">Dynamics 365 Commerce Scale Unit Basic - Cloud</span></span>|
|<span data-ttu-id="9ef9e-471">Zobrazit a PFAM</span><span class="sxs-lookup"><span data-stu-id="9ef9e-471">Display and PFAM</span></span>|<span data-ttu-id="9ef9e-472">Dynamics 365 Commerce Cloud Unit Scale úrovně Premium</span><span class="sxs-lookup"><span data-stu-id="9ef9e-472">Dynamics 365 Commerce Cloud Scale Unit Premium</span></span>|<span data-ttu-id="9ef9e-473">Dynamics 365 Commerce Scale Unit úrovně Premium – Cloud</span><span class="sxs-lookup"><span data-stu-id="9ef9e-473">Dynamics 365 Commerce Scale Unit Premium - Cloud</span></span>|

### <a name="additional-resources"></a><span data-ttu-id="9ef9e-474">Další materiály</span><span class="sxs-lookup"><span data-stu-id="9ef9e-474">Additional resources</span></span>

- [<span data-ttu-id="9ef9e-475">Domovská stránka Dynamics 365</span><span class="sxs-lookup"><span data-stu-id="9ef9e-475">Dynamics 365 Home Page</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="9ef9e-476">Stránka s přehledem pro aplikace hybridní reality</span><span class="sxs-lookup"><span data-stu-id="9ef9e-476">Mixed Reality Apps Guide Home Page</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="9ef9e-477">Domovská stránka s podvody pro podvod aplikací</span><span class="sxs-lookup"><span data-stu-id="9ef9e-477">Biz Apps Fraud Home Page</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="9ef9e-478">FY20 PowerApps a aktualizace licencování Flow</span><span class="sxs-lookup"><span data-stu-id="9ef9e-478">FY20 PowerApps and Flow Licensing Updates</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="9ef9e-479">Licence k Microsoft Dynamics 365</span><span class="sxs-lookup"><span data-stu-id="9ef9e-479">Microsoft Dynamics 365 Licensing</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="9ef9e-480">Dynamics 365 a Power Platform – dostupnost, umístění dat, jazyk a lokalizace obsahu</span><span class="sxs-lookup"><span data-stu-id="9ef9e-480">Dynamics 365 and Power Platforms-Availability, data location, language, and localization content</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="9ef9e-481">FY20, co je nového webinář Series</span><span class="sxs-lookup"><span data-stu-id="9ef9e-481">FY20 What's New Webinar Series</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="9ef9e-482">FY20 Technical Readiness webinář Series</span><span class="sxs-lookup"><span data-stu-id="9ef9e-482">FY20 Technical Readiness Webinar Series</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="9ef9e-483">Automatizace automatických procesů (RPA)</span><span class="sxs-lookup"><span data-stu-id="9ef9e-483">Robotic Process Automation (RPA)</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)

### <a name="next-steps"></a><span data-ttu-id="9ef9e-484">Další kroky</span><span class="sxs-lookup"><span data-stu-id="9ef9e-484">Next steps</span></span>

<span data-ttu-id="9ef9e-485">Tyto informace prosím sdílejte s příslušnými kontakty ve vaší organizaci.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-485">Please share this information with appropriate contacts in your organization.</span></span> <span data-ttu-id="9ef9e-486">Další podrobnosti o aktualizacích licencí a jejich hodnotách najdete v části Další materiály v části Další zdroje informací a na portálu PartnerSource.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-486">For more details on the licensing updates and the value proposition, please familiarize yourself with our readiness content in the "Additional resources" section, and on PartnerSource.</span></span>

### <a name="questions"></a><span data-ttu-id="9ef9e-487">Máte otázky?</span><span class="sxs-lookup"><span data-stu-id="9ef9e-487">Questions?</span></span>

<span data-ttu-id="9ef9e-488">Pro usnadnění striktního přístupu k vašemu provozu v Microsoftu se prosím obraťte [na podporu](https://partner.microsoft.com/pcv/servicerequests/create).</span><span class="sxs-lookup"><span data-stu-id="9ef9e-488">For help strictly relating to your operations with Microsoft, please [reach out to support](https://partner.microsoft.com/pcv/servicerequests/create).</span></span>

_________________

## <a name="now-available---operations-readiness-resources-in-one-place"></a><a id="3"/></a><span data-ttu-id="9ef9e-489">Nyní dostupné – prostředky připravenosti operací na jednom místě</span><span class="sxs-lookup"><span data-stu-id="9ef9e-489">Now available - Operations readiness resources in one place</span></span>

### <a name="categories"></a><span data-ttu-id="9ef9e-490">Kategorie</span><span class="sxs-lookup"><span data-stu-id="9ef9e-490">Categories</span></span>

- <span data-ttu-id="9ef9e-491">Datum: 2020-04-03</span><span class="sxs-lookup"><span data-stu-id="9ef9e-491">Date: 2020-04-03</span></span>
- <span data-ttu-id="9ef9e-492">Typ: možnosti</span><span class="sxs-lookup"><span data-stu-id="9ef9e-492">Type: Capabilities</span></span>
- <span data-ttu-id="9ef9e-493">Stav: nyní k dispozici</span><span class="sxs-lookup"><span data-stu-id="9ef9e-493">Status: Now Available</span></span>
- [<span data-ttu-id="9ef9e-494">Další informace</span><span class="sxs-lookup"><span data-stu-id="9ef9e-494">Learn more</span></span>](https://partner.microsoft.com/resources/collection/readiness-in-one-place#/)

### <a name="impacted-audience"></a><span data-ttu-id="9ef9e-495">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="9ef9e-495">Impacted audience</span></span>
- <span data-ttu-id="9ef9e-496">Všichni partneři CSP</span><span class="sxs-lookup"><span data-stu-id="9ef9e-496">All CSP partners</span></span>

### <a name="summary"></a><span data-ttu-id="9ef9e-497">Souhrn</span><span class="sxs-lookup"><span data-stu-id="9ef9e-497">Summary</span></span>

<span data-ttu-id="9ef9e-498">[Umístění prostředků připravenosti na operace](https://partner.microsoft.com/resources#/) je teď aktivní a poskytuje partnerům jedno umístění pro prostředky připravenosti na operace. díky tomu je snazší než dřív najít nejnovější aktualizace a klíčové prostředky pro provozní připravenost napříč všemi kanály a programy Microsoftu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-498">The [Operations Readiness resource location](https://partner.microsoft.com/resources#/) is now live, providing partners with one location for operations readiness resources, making it easier than ever to find the latest updates and key operational readiness resources across all Microsoft channels and programs.</span></span> <span data-ttu-id="9ef9e-499">Program CSP aktualizoval galerii prostředků a obsah připravenosti Microsoftu se přesunul do umístění prostředku připravenosti operací a adresa URL, na kterou se odkazuje Galerie prostředků aktualizace programu CSP ( [https://partner.microsoft.com/resources#/](https://partner.microsoft.com/resources#/) ), aby odkazovala na umístění prostředku připravenosti na operace.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-499">The CSP Program Updates Resource gallery and Microsoft Readiness content has been moved to the Operations Readiness resource location and the URL pointing to the CSP Program Update Resource Gallery ([https://partner.microsoft.com/resources#/](https://partner.microsoft.com/resources#/)) has been updated to point to the Operations Readiness resource location.</span></span>

<span data-ttu-id="9ef9e-500">Další podrobnosti o tomto novém prostředí a některých oblastech, které se budou dál vyvíjet během několika dalších týdnů, najdete v [aktualizovaných nejčastějších dotazech](https://assetsprod.microsoft.com/mpn/readiness-in-one-place-partner-login-faq.pdf) .</span><span class="sxs-lookup"><span data-stu-id="9ef9e-500">Please review the [updated FAQ](https://assetsprod.microsoft.com/mpn/readiness-in-one-place-partner-login-faq.pdf) here for further details on this new experience and some areas that will continue to evolve over the next few weeks.</span></span>

<span data-ttu-id="9ef9e-501">**Váš názor je pro nás důležitý!**</span><span class="sxs-lookup"><span data-stu-id="9ef9e-501">**Your feedback is important to us!**</span></span> <span data-ttu-id="9ef9e-502">Když použijete nové umístění připravenosti na operace, budeme vás pozvat k tomu, abyste mohli dál vylepšit vaše zkušenosti.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-502">As you use the new Operations Readiness location, we invite you to leave feedback so we can continue to improve your experience.</span></span> <span data-ttu-id="9ef9e-503">Můžete to udělat pomocí této stránky, která je **užitečná? Ano |** V dolní části každé stránky není k dispozici žádný nástroj pro zpětnou vazbu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-503">You can do this by using the **Was this page helpful? Yes | No** feedback tool available at the bottom of each page.</span></span>

<span data-ttu-id="9ef9e-504">Microsoft zjednodušuje způsob, jakým komunikujeme a poskytujeme materiály pro připravenost napříč všemi programy Microsoftu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-504">Microsoft is streamlining the way we communicate and provide readiness materials across all Microsoft programs.</span></span> <span data-ttu-id="9ef9e-505">Zavádíme jedno umístění prostředku připravenosti na provoz na webu Microsoft Partner na webu [https://partner.microsoft.com](https://partner.microsoft.com) , který bude kombinovat prostředky z [Galerie prostředků aktualizace programu CSP](https://partner.microsoft.com/resources#/) a [webu připravenosti Microsoftu](https://www.microsoftreadiness.com/).</span><span class="sxs-lookup"><span data-stu-id="9ef9e-505">We are introducing one Operations Readiness resource location on the Microsoft partner website at [https://partner.microsoft.com](https://partner.microsoft.com) that will combine assets from the [CSP Program Updates Resource Gallery](https://partner.microsoft.com/resources#/) and the [Microsoft Readiness site](https://www.microsoftreadiness.com/).</span></span>

<span data-ttu-id="9ef9e-506">Po jednom umístění prostředků připravenosti operací bude pro partnery snazší než kdy dřív najít nejnovější aktualizace, kritická oznámení a klíčové prostředky provozní připravenosti ve všech kanálech a programech Microsoftu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-506">With one location for operations readiness resources, it will be easier than ever for partners to find the latest updates, critical announcements, and key operational readiness resources across all Microsoft channels and programs.</span></span> <span data-ttu-id="9ef9e-507">Díky jednotnému přihlašování a lepšímu vyhledávání, filtrování a řazení schopností můžou partneři snadno přistupovat k podnikům, využívat je a připravovat jejich firmy, aby mohli pracovat s Microsoftem, a to způsobem, který pro ně funguje.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-507">With a single sign-on experience and enhanced search, filter, and sort capabilities partners can easily access, consume, and prepare their businesses to successfully transact and do business with Microsoft in the way that works for them.</span></span>

### <a name="expanding-on-the-success-of-the-csp-program-updates-resource-gallery"></a><span data-ttu-id="9ef9e-508">Rozšíření o úspěšnosti Galerie prostředků aktualizace programu CSP:</span><span class="sxs-lookup"><span data-stu-id="9ef9e-508">Expanding on the success of the CSP Program Updates Resource Gallery:</span></span>

<span data-ttu-id="9ef9e-509">Umístění prostředků připravenosti operací na partner.microsoft.com bude fungovat podobně jako aktuální Galerie prostředků aktualizace programu CSP s některými významnými vylepšeními a úpravami, včetně těchto:</span><span class="sxs-lookup"><span data-stu-id="9ef9e-509">The operations readiness resource location on partner.microsoft.com will function much like the current CSP Program Update Resource Gallery with some notable enhancements and modifications, including:</span></span>

- <span data-ttu-id="9ef9e-510">**Stránky programu:** Hledání nejaktuálnějších aktualizací dokumentů pro určitý program bude jednoduché u stránek, které jsou předem filtrovány na obsah pouze pro tento program.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-510">**Program Pages:** Finding the most recent document updates for a specific program will be made easy with pages that are pre-filtered to content only for that program.</span></span>
- <span data-ttu-id="9ef9e-511">**Výkonné hledání v galerii:** Filtry obsahu umožní rychlejší a jednodušší hledání obsahu napříč programy a obsahem, například CSP.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-511">**Powerful gallery search:** Content filters will make finding content across programs and content faster and simpler, for example, CSP.</span></span>
- <span data-ttu-id="9ef9e-512">**Oznámení:** Vyhledání nejnovějších oznámení a nejaktuálnější aktualizace dokumentů pro určitý program budou snazší u stránek, které jsou předem filtrovány na obsah pouze pro tento program.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-512">**Announcements:** Finding the latest announcements and most recent document updates for a specific program will be easier with pages that are pre-filtered to content only for that program.</span></span> <span data-ttu-id="9ef9e-513">Bude se jednat o stránku programu pro zprostředkovatele CSP, ale oznámení CSP budou i nadále odesílána v partnerském centru.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-513">There will be a program page for CSP as well however CSP announcements will continue to be posted in Partner Center.</span></span>
- <span data-ttu-id="9ef9e-514">**Nové umístění:** Jakmile je nové umístění pro provozní prostředky v partner.microsoft.com živé, lokalita služby Readiness a galerie prostředků aktualizace programu CSP nebude nadále dostupná a bude uživatele přesměrovat na nové umístění prostředků operací.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-514">**New location:** Once the new location for operations resources is live on partner.microsoft.com, the Microsoft Readiness site and the CSP Program Updates Resource Gallery will no longer be accessible and will redirect users to the new operations resource location.</span></span> <span data-ttu-id="9ef9e-515">Partneři budou moci využívat filtry programů obsahu, aby je mohli filtrovat na CSP nebo jiné konkrétní programové prostředky.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-515">Partners will be able to leverage content program filters to filter to CSP or other specific program resources.</span></span>
- <span data-ttu-id="9ef9e-516">**Rozbalený obsah:** Veškerý poslední a relevantní obsah z webu připravenosti Microsoftu a galerie prostředků aktualizace programu CSP se přemístí do nového umístění připravenosti operací, což znamená, že obsah pro další programy se teď bude nacházet v jednom umístění.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-516">**Content expanded:** All recent and relevant content from the Microsoft Readiness site and the CSP Program Updates Resource Gallery will be relocated to the new operations readiness location meaning content for more programs will now be housed in one location.</span></span>

### <a name="next-steps"></a><span data-ttu-id="9ef9e-517">Další kroky</span><span class="sxs-lookup"><span data-stu-id="9ef9e-517">Next steps</span></span>

<span data-ttu-id="9ef9e-518">Co byste měli dělat při přípravě?</span><span class="sxs-lookup"><span data-stu-id="9ef9e-518">What should you do to prepare?</span></span>

- <span data-ttu-id="9ef9e-519">**Další informace** o novém umístění webu partnera společnosti Microsoft pro prostředky připravenosti operací najdete v aktualizovaných materiálech připravenosti v galerii galerie, které [přijdou na jednom místě prostředky připravenosti na provoz](https://partner.microsoft.com/resources/collection/readiness-in-one-place#/).</span><span class="sxs-lookup"><span data-stu-id="9ef9e-519">**Learn more** about the new Microsoft partner website location for operations readiness resources by reviewing the updated readiness materials at the gallery collection [Coming soon - Operations readiness resources in one place](https://partner.microsoft.com/resources/collection/readiness-in-one-place#/).</span></span>
- <span data-ttu-id="9ef9e-520">**Zúčastněte se Partnerská komunita** , kde si můžete přečíst další informace o novém prostředí a klást otázky: [https://globalpbocomm.eventbuilder.com/GlobalCSP](https://globalpbocomm.eventbuilder.com/GlobalCSP)</span><span class="sxs-lookup"><span data-stu-id="9ef9e-520">**Attend an April partner community call** where you can learn more about the new experience and ask questions: [https://globalpbocomm.eventbuilder.com/GlobalCSP](https://globalpbocomm.eventbuilder.com/GlobalCSP)</span></span>

### <a name="questions"></a><span data-ttu-id="9ef9e-521">Máte otázky?</span><span class="sxs-lookup"><span data-stu-id="9ef9e-521">Questions?</span></span>

<span data-ttu-id="9ef9e-522">Obraťte se prosím na [podporu](https://partner.microsoft.com/dashboard/support/csp/servicerequests/create?category=csp) s dotazy, dotazy nebo dalšími informacemi.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-522">Please [contact Support](https://partner.microsoft.com/dashboard/support/csp/servicerequests/create?category=csp) for questions, queries, or more information.</span></span>

### <a name="change-log"></a><span data-ttu-id="9ef9e-523">Protokol změn</span><span class="sxs-lookup"><span data-stu-id="9ef9e-523">Change log</span></span>

- <span data-ttu-id="9ef9e-524">3. dubna 2020: Aktualizováno na nyní k dispozici</span><span class="sxs-lookup"><span data-stu-id="9ef9e-524">April 3, 2020: Updated to Now Available</span></span>
- <span data-ttu-id="9ef9e-525">23. března 2020: program CSP aktualizuje přechod z Galerie prostředků na umístění prostředků připravenosti na operace, které se aktualizovaly na 3. dubna 2020.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-525">March 23, 2020: CSP Program Updates Resource Gallery transition to Operations Readiness resource location updated to April 3, 2020</span></span>
- <span data-ttu-id="9ef9e-526">9. března 2020: upozornění na 30 dní, aktualizované materiály připravenosti</span><span class="sxs-lookup"><span data-stu-id="9ef9e-526">March 9, 2020: 30-Day notice, updated readiness materials</span></span>
- <span data-ttu-id="9ef9e-527">14. února 2020: původní datum publikování</span><span class="sxs-lookup"><span data-stu-id="9ef9e-527">February 14, 2020: Original publication date</span></span>

_________________

## <a name="microsoft-365-business-voice-available-to-csp-partners-from-april-1-2020"></a><a id="2"/></a><span data-ttu-id="9ef9e-528">Microsoft 365 Business hlasový přístup k partnerům CSP od 1. dubna 2020</span><span class="sxs-lookup"><span data-stu-id="9ef9e-528">Microsoft 365 Business Voice available to CSP partners from April 1, 2020</span></span>

### <a name="categories"></a><span data-ttu-id="9ef9e-529">Kategorie</span><span class="sxs-lookup"><span data-stu-id="9ef9e-529">Categories</span></span>

- <span data-ttu-id="9ef9e-530">Datum: 2020-04-01</span><span class="sxs-lookup"><span data-stu-id="9ef9e-530">Date: 2020-04-01</span></span>
- <span data-ttu-id="9ef9e-531">Typ: nabídky/trhy</span><span class="sxs-lookup"><span data-stu-id="9ef9e-531">Type: Offers/Markets</span></span>
- <span data-ttu-id="9ef9e-532">Stav: nyní k dispozici</span><span class="sxs-lookup"><span data-stu-id="9ef9e-532">Status: Now Available</span></span>
- [<span data-ttu-id="9ef9e-533">Další informace</span><span class="sxs-lookup"><span data-stu-id="9ef9e-533">Learn more</span></span>](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)

### <a name="summary"></a><span data-ttu-id="9ef9e-534">Souhrn</span><span class="sxs-lookup"><span data-stu-id="9ef9e-534">Summary</span></span>

<span data-ttu-id="9ef9e-535">Microsoft 365 Business hlasu, cloudový telefonní systém sestavený pro malé a střední firmy, bude dostupný v zemích uvedených od 1. dubna 2020.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-535">Microsoft 365 Business Voice, a cloud-based phone system built for small and medium businesses, will be available in the countries listed here from April 1, 2020.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="9ef9e-536">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="9ef9e-536">Impacted audience</span></span>

- <span data-ttu-id="9ef9e-537">Všichni partneři CSP působící v [těchto zemích](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/).</span><span class="sxs-lookup"><span data-stu-id="9ef9e-537">All CSP partners operating in [these countries](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/).</span></span>
- <span data-ttu-id="9ef9e-538">Partneři v Austrálii by měli ověřit naše doprovodné materiály.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-538">Partners in Australia should check our guidance below.</span></span>

### <a name="details"></a><span data-ttu-id="9ef9e-539">Podrobnosti</span><span class="sxs-lookup"><span data-stu-id="9ef9e-539">Details</span></span>

<span data-ttu-id="9ef9e-540">Od 1. dubna 2020 začne Microsoft Microsoft 365 Business hlas do dalších geografických oblastí.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-540">On April 1, 2020, Microsoft will introduce Microsoft 365 Business Voice to additional geographies.</span></span> <span data-ttu-id="9ef9e-541">Budou k dispozici dvě nabídky: Microsoft 365 Business hlasu a Microsoft 365 Business hlas bez volání plánu (pomocí přímého směrování).</span><span class="sxs-lookup"><span data-stu-id="9ef9e-541">Two offers will be available: Microsoft 365 Business Voice, and Microsoft 365 Business Voice Without Calling Plan (using direct routing).</span></span> <span data-ttu-id="9ef9e-542">Obě nabídky budou k dispozici v USA.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-542">Both offers will be available in the U.S.</span></span>

### <a name="customer-value-proposition"></a><span data-ttu-id="9ef9e-543">Změna hodnoty zákazníka</span><span class="sxs-lookup"><span data-stu-id="9ef9e-543">Customer value proposition</span></span>

<span data-ttu-id="9ef9e-544">Microsoft 365 Business hlas je cloudový telefonní systém pro firmy až 300 uživatelů.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-544">Microsoft 365 Business Voice is a cloud-based phone system for businesses of up to 300 users.</span></span> <span data-ttu-id="9ef9e-545">Poskytuje možnost vytvářet a přijímat volání z libovolného telefonního čísla v Microsoft Teams.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-545">It provides the ability to make and receive calls from any phone number in Microsoft Teams.</span></span> <span data-ttu-id="9ef9e-546">Spolu s týmy nabízí řešení pro komunikaci s jedním v jednom, které spojuje volání, chat a schůzky.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-546">Together with Teams, it delivers an all-in-one communication solution combining calling, chat, and meetings.</span></span>

<span data-ttu-id="9ef9e-547">Microsoft 365 Business hlas zjednodušuje a zjednodušuje produktivitu a komunikaci do jediné aplikace, která funguje kdekoli, kde se firmy nacházejí: na počítačích, na inteligentních telefonech a na kancelářských telefonech.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-547">Microsoft 365 Business Voice simplifies and streamlines productivity and communications into a single application that works wherever businesses do: on computers, smart phones, and desk phones.</span></span> <span data-ttu-id="9ef9e-548">Mezi výhody Microsoft 365 Businessho hlasu patří:</span><span class="sxs-lookup"><span data-stu-id="9ef9e-548">The benefits of Microsoft 365 Business Voice include:</span></span>

- <span data-ttu-id="9ef9e-549">Komunikace po jednom.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-549">All-in-one communication.</span></span> <span data-ttu-id="9ef9e-550">Transformujte, jak se práce provede sjednocením volání, chatu, schůzek, kalendáře a e-mailu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-550">Transform how work gets done by unifying calling, chat, meetings, calendar, and email.</span></span>
- <span data-ttu-id="9ef9e-551">Snadné a inteligentní volání.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-551">Easy and intelligent calling.</span></span> <span data-ttu-id="9ef9e-552">Komunikujte s větší flexibilitou, snadným a inteligentním přehledem, abyste mohli zůstat připojení.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-552">Communicate with more flexibility, ease, and intelligence, so you can stay connected.</span></span>
- <span data-ttu-id="9ef9e-553">Dodávána z cloudu Microsoftu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-553">Delivered from the Microsoft cloud.</span></span> <span data-ttu-id="9ef9e-554">Spolehlivě Pracujte s spolehlivým a bezpečným cloudovým řešením.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-554">Work confidently with a reliable and secure cloud-based solution.</span></span>

<span data-ttu-id="9ef9e-555">Microsoft 365 Business hlas je k dispozici jako doplněk k následujícím plánům:</span><span class="sxs-lookup"><span data-stu-id="9ef9e-555">Microsoft 365 Business Voice is available as an add-on to the following plans:</span></span>

- <span data-ttu-id="9ef9e-556">Office 365 Business Essentials, Business Premium, F1, a1, E1, a3, E3</span><span class="sxs-lookup"><span data-stu-id="9ef9e-556">Office 365 Business Essentials, Business Premium, F1, A1, E1, A3, E3</span></span>
- <span data-ttu-id="9ef9e-557">Microsoft 365 Business, F1, a3, E3</span><span class="sxs-lookup"><span data-stu-id="9ef9e-557">Microsoft 365 Business, F1, A3, E3</span></span>

### <a name="partner-value-proposition"></a><span data-ttu-id="9ef9e-558">Přemístění hodnoty partnerského serveru</span><span class="sxs-lookup"><span data-stu-id="9ef9e-558">Partner value proposition</span></span>

<span data-ttu-id="9ef9e-559">Partneři mohou tuto příležitost monetizovat:</span><span class="sxs-lookup"><span data-stu-id="9ef9e-559">Partners can monetize this opportunity by:</span></span>

- <span data-ttu-id="9ef9e-560">Povolení telefonního systému s frontami volání, automatickými možnostmi vyhodnocování kvality sítě nebo konfigurací přímého směrování a zvukových konferencí.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-560">Enabling the phone system with Call Queues/Auto-Attendant, assessing the network quality, or configuring Direct Routing and audio conferencing.</span></span>
- <span data-ttu-id="9ef9e-561">Nabídnutí služeb pro přijetí a školení uživatelů k zabezpečení připravenosti organizace a zahájení používání moderního komunikačního nástroje, Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="9ef9e-561">Offering user adoption/training services to secure organization readiness and start using the modern communication tool, Microsoft Teams.</span></span>
- <span data-ttu-id="9ef9e-562">Podpora a monitorování prostředí zákazníka pomocí spravovaných služeb, jako jsou vytváření sestav kvality, Správa zařízení a podpora uživatelů.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-562">Supporting and monitoring the customer environment with managed services like quality reporting, device management, and user support.</span></span>

<span data-ttu-id="9ef9e-563">**Microsoft 365 Business hlas (USA, Kanada, Spojené království)**</span><span class="sxs-lookup"><span data-stu-id="9ef9e-563">**Microsoft 365 Business Voice (United States, Canada, United Kingdom)**</span></span>

<span data-ttu-id="9ef9e-564">Od 1. dubna 2020 bude obchodní hlas se zavoláním plánů k dispozici k nákupu v USA, a to po svém spuštění v rámci Spojeného království a Kanady v listopadu 2019.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-564">On April 1, 2020, Business Voice with calling plans will be available for purchase in the United States, following our launch in the United Kingdom and Canada in November 2019.</span></span>

<span data-ttu-id="9ef9e-565">Nabídka doplňku bude k dispozici také pro zákazníky, kteří hledají možnosti mezinárodního volání.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-565">An add-on offer will also be available for those customers seeking international calling capabilities.</span></span>

- <span data-ttu-id="9ef9e-566">Microsoft 365 Business hlas: 9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span><span class="sxs-lookup"><span data-stu-id="9ef9e-566">Microsoft 365 Business Voice: 9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span></span>
- <span data-ttu-id="9ef9e-567">Microsoft 365 mezinárodní plán volání pro protokol SMB: c01a89e5-d246-42d6-b21a-f4a1e9b04f56</span><span class="sxs-lookup"><span data-stu-id="9ef9e-567">Microsoft 365 International Calling Plan for SMB: c01a89e5-d246-42d6-b21a-f4a1e9b04f56</span></span>

<span data-ttu-id="9ef9e-568">**Microsoft 365 Business hlas bez volání plánu (70 + země)**</span><span class="sxs-lookup"><span data-stu-id="9ef9e-568">**Microsoft 365 Business Voice Without Calling Plan (70+ countries)**</span></span>

<span data-ttu-id="9ef9e-569">Alternativně můžete od 1. dubna 2020 zakoupit obchodní hlas bez volání nabídky plán, která zahrnuje telefonní systém a zvukové konference.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-569">Alternatively, from April 1, 2020, you can purchase the Business Voice Without Calling Plan offer, which includes phone system and audio conferencing.</span></span> <span data-ttu-id="9ef9e-570">Tato nabídka je k dispozici ve všech zemích, které jsou zde uvedeny.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-570">This offer is available in all countries listed here.</span></span>

- <span data-ttu-id="9ef9e-571">**Pouze USA:** Microsoft 365 Business hlas bez volání plánu: 39d77d0f-eb8f-4ebc-b618-692e1cc59c8f</span><span class="sxs-lookup"><span data-stu-id="9ef9e-571">**United States only:** Microsoft 365 Business Voice Without Calling Plan: 39d77d0f-eb8f-4ebc-b618-692e1cc59c8f</span></span>
- <span data-ttu-id="9ef9e-572">**Zbytek světa:** Microsoft 365 Business hlas bez volání plánu: cc69a07c-8c51-457f-bb2a-f21a62d6bede</span><span class="sxs-lookup"><span data-stu-id="9ef9e-572">**Rest of the world:** Microsoft 365 Business Voice Without Calling Plan: cc69a07c-8c51-457f-bb2a-f21a62d6bede</span></span>

<span data-ttu-id="9ef9e-573">Zapojte se do místní pobočky, abyste porozuměli tomu, jak z této nabídky těžit.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-573">Please engage with your local subsidiary to understand how to benefit from this offer.</span></span>

### <a name="additional-guidance-for-partners-in-the-united-states-and-puerto-rico"></a><span data-ttu-id="9ef9e-574">Další pokyny pro partnery v USA a Portoriko</span><span class="sxs-lookup"><span data-stu-id="9ef9e-574">Additional guidance for partners in the United States and Puerto Rico</span></span>

<span data-ttu-id="9ef9e-575">V USA a Portoriko je obchodním hlasem nabídka DPH.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-575">In the US and Puerto Rico, Business Voice is a tax-inclusive offer.</span></span> <span data-ttu-id="9ef9e-576">Cena, která se účtuje partnerům a placeným partnerům Microsoftu, zahrnuje i poplatky za výpovědi a daně z USA.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-576">The price billed to Partners and paid by Partners to Microsoft includes applicable US telco taxes and fees.</span></span> <span data-ttu-id="9ef9e-577">Na jiných trzích se daně použijí na základě normálního fakturačního procesu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-577">In other markets, taxes will be applied per the normal invoicing process.</span></span> <span data-ttu-id="9ef9e-578">Před tím, než se rozhodnete, že chcete obchodní hlas označit, kontaktujte prosím své právní poradenství o převrácení daně.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-578">Please talk to your legal counsel about remitting taxes, before deciding to mark-up Business Voice.</span></span> <span data-ttu-id="9ef9e-579">Pokud je obchodní hlas označený, partner potřebuje způsob, jak uhradit daně z výpovědi.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-579">If Business Voice is marked up, the Partner needs to a way to remit the telco taxes.</span></span> <span data-ttu-id="9ef9e-580">V opačném případě by partner neplatíte přírůstkovou daň na označení, což vede k porušení daňových nároků.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-580">Otherwise, partner would not be paying the incremental tax on the mark-up, resulting in tax violations.</span></span> <span data-ttu-id="9ef9e-581">Společnost Microsoft poskytuje partnerům pro obchodní telefony v USA další pobídky CSP, aby bylo možné kompenzovat případné chybějící okraje.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-581">Microsoft provides additional CSP incentives to partners for Business Voice in the US, to compensate for potential lack of margin.</span></span>

### <a name="guidance-for-partners-in-australia"></a><span data-ttu-id="9ef9e-582">Doprovodné materiály k partnerům v Austrálii</span><span class="sxs-lookup"><span data-stu-id="9ef9e-582">Guidance for partners in Australia</span></span>

<span data-ttu-id="9ef9e-583">Partneři v Austrálii by si měli být vědomi, že nabídka Microsoft 365 Business hlas bez volání plánu nebude k dispozici v seznamu produkčních cen od 1. dubna 2020, a to navzdory tomu, že je k dispozici v ceníku Preview v březnu 2020.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-583">Partners in Australia should be aware that the offer Microsoft 365 Business Voice Without Calling Plan will not be available on the production price list on April 1, 2020 – despite being available on the preview price list in March 2020.</span></span> <span data-ttu-id="9ef9e-584">Děkujeme vám za vaše porozumění.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-584">Thank you for your understanding.</span></span>

### <a name="further-countries"></a><span data-ttu-id="9ef9e-585">Další země</span><span class="sxs-lookup"><span data-stu-id="9ef9e-585">Further countries</span></span>

<span data-ttu-id="9ef9e-586">V průběhu času doufáme, že Microsoft 365 Business hlas všem zemím, kde jsou k dispozici Office 365 a Microsoft 365.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-586">Over time, we hope to bring Microsoft 365 Business Voice to all countries where Office 365 and Microsoft 365 are available.</span></span>

### <a name="next-steps"></a><span data-ttu-id="9ef9e-587">Další kroky</span><span class="sxs-lookup"><span data-stu-id="9ef9e-587">Next steps</span></span>

- <span data-ttu-id="9ef9e-588">Podívejte se na naši galerii partnerů, kde se dozvíte víc o tom, jak se tato nabídka nachází v této nabídce, a taky vytvořit a konsolidovat postupy Microsoft Teams: [Microsoft 365 Business dostupnosti hlasu v CSP](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/) .</span><span class="sxs-lookup"><span data-stu-id="9ef9e-588">Check our partner gallery to know more about the value proposition of this offer, as well to establish, and consolidate your Microsoft Teams practice: [Microsoft 365 Business Voice availability in CSP](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)</span></span>
- <span data-ttu-id="9ef9e-589">Seznamte se s cenami ve verzi Preview a sdílejte tyto informace se všemi příslušnými kontakty ve vaší organizaci.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-589">Please familiarize yourself with the preview price list and share this information with all appropriate contacts in your organization.</span></span>
- <span data-ttu-id="9ef9e-590">Kontaktujte prosím svůj místní partner týmu, abyste se dozvěděli víc o této nabídce a mohli účinně přejít na trh.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-590">Please engage with your local One Commercial Partner team to know more about this offer and how to go to market effectively</span></span>

### <a name="questions"></a><span data-ttu-id="9ef9e-591">Máte otázky?</span><span class="sxs-lookup"><span data-stu-id="9ef9e-591">Questions?</span></span>

<span data-ttu-id="9ef9e-592">Pokud chcete získat další otázky týkající se těchto nabídek, obraťte se na svého zástupce v rámci jednoho komerčního týmu partnerů Microsoftu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-592">For any further questions about these offers, please contact your representative in the Microsoft One Commercial Partner team.</span></span>

### <a name="change-log"></a><span data-ttu-id="9ef9e-593">Protokol změn</span><span class="sxs-lookup"><span data-stu-id="9ef9e-593">Change log</span></span>

- <span data-ttu-id="9ef9e-594">M365 Business Voice k dispozici pro zákazníky v USA: 1. dubna 2020</span><span class="sxs-lookup"><span data-stu-id="9ef9e-594">M365 Business Voice available for US customers: April 1, 2020</span></span>
- <span data-ttu-id="9ef9e-595">M365 Business Voice bez volání plánu volání: 1. dubna 2020</span><span class="sxs-lookup"><span data-stu-id="9ef9e-595">M365 Business Voice without calling plan launch: April 1, 2020</span></span>
- <span data-ttu-id="9ef9e-596">Datum původní publikace: 5. listopadu 2019</span><span class="sxs-lookup"><span data-stu-id="9ef9e-596">Original publication date: November 5, 2019</span></span>

_________________

## <a name="act-now-partners-are-now-required-to-have-accepted-the-microsoft-partner-agreement"></a><a id="1"/></a><span data-ttu-id="9ef9e-597">Vyjednání: partneři teď vyžadují, aby uzavřeli smlouvu o partnerovi Microsoftu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-597">Act now: Partners are now required to have accepted the Microsoft Partner Agreement.</span></span>

### <a name="categories"></a><span data-ttu-id="9ef9e-598">Kategorie</span><span class="sxs-lookup"><span data-stu-id="9ef9e-598">Categories</span></span>

- <span data-ttu-id="9ef9e-599">Datum: 2020-04-01</span><span class="sxs-lookup"><span data-stu-id="9ef9e-599">Date: 2020-04-01</span></span>
- <span data-ttu-id="9ef9e-600">Typ: možnosti</span><span class="sxs-lookup"><span data-stu-id="9ef9e-600">Type: Capabilities</span></span>
- <span data-ttu-id="9ef9e-601">Stav: nyní k dispozici</span><span class="sxs-lookup"><span data-stu-id="9ef9e-601">Status: Now Available</span></span>
- [<span data-ttu-id="9ef9e-602">Další informace</span><span class="sxs-lookup"><span data-stu-id="9ef9e-602">Learn more</span></span>](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp)

### <a name="impacted-audience"></a><span data-ttu-id="9ef9e-603">Ovlivněná cílová skupina</span><span class="sxs-lookup"><span data-stu-id="9ef9e-603">Impacted audience</span></span>
<span data-ttu-id="9ef9e-604">Všichni partneři CSP.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-604">All CSP partners.</span></span>

<span data-ttu-id="9ef9e-605">**Aktualizace od 1. dubna 2020** Od 31. ledna 2020 měly všichni partneři v programu Cloud Solution Provider (CSP) přijmout smlouvu pro všechny jejich klienty CSP v tomto jazyce.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-605">**April 1, 2020 Update** As of 31 January 2020, all partners in the Cloud Solution Provider (CSP) Program should have accepted the agreement for all of their transacting CSP tenants.</span></span> <span data-ttu-id="9ef9e-606">Dříve jsme komunikovali, že další fáze implementace smlouvy by začala v dubnu 2020.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-606">We previously communicated that the next phase of implementation for the agreement would begin in April 2020.</span></span><span data-ttu-id="9ef9e-607">Aby se zabránilo jakémukoli narušení podniku, rozhodli jsme se po dobu od dubna 2020 zvýšit další fázi implementace.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-607">  To help prevent any disruption to business, we have decided to extend the next phase of implementation beyond April 2020.</span></span> <span data-ttu-id="9ef9e-608">Dostali jsme zpětnou vazbu od našich partnerů poskytovatele Cloud Solution Provider, u kterých došlo k potížím při přijímání aktivace.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-608">We have received feedback from some of our Cloud Solution Provider Partners that they have experienced issues accepting the MPA.</span></span> <span data-ttu-id="9ef9e-609">Na základě těchto okolností pracujeme na tom, abychom zajistili poskytování prostředků Microsoftu pro podporu partnerů, kteří mají potíže s přijetím smlouvy.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-609">Based on these circumstances, we are working toward ensuring Microsoft resources are in place to support partners who have been having trouble accepting the agreement.</span></span>

### <a name="summary"></a><span data-ttu-id="9ef9e-610">Souhrn</span><span class="sxs-lookup"><span data-stu-id="9ef9e-610">Summary</span></span>
<span data-ttu-id="9ef9e-611">Od 31. ledna 2020 by všichni partneři v programu Cloud Solution Provider, včetně nepřímých prodejců, měli mít Smlouvu s partnerem Microsoftu, aby se zajistilo, že nedojde k přerušení jejich možnosti vytvářet nové zákazníky nebo objednávky pro stávající zákazníky v programu CSP.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-611">As of January 31, 2020, all partners in the Cloud Solution Provider program should have accepted the Microsoft Partner Agreement, including Indirect Resellers, to ensure no disruption of their ability to create new customers or place new orders for existing customers in the CSP program.</span></span> <span data-ttu-id="9ef9e-612">Přijetí Smlouvy s partnerem Microsoftu se teď vyžaduje od všech partnerů v programu CSP.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-612">Acceptance of the Microsoft Partner Agreement is now required for all partners in the CSP program.</span></span>

<span data-ttu-id="9ef9e-613">Od dubna 2020:</span><span class="sxs-lookup"><span data-stu-id="9ef9e-613">Starting in April, 2020:</span></span>
- <span data-ttu-id="9ef9e-614">Partneři s přímým přístupem a nepřímými poskytovateli, kteří nepřijali smlouvu o partnerovi Microsoftu, nebudou moci umístit nové objednávky a budou omezené jenom na správu stávajících předplatných.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-614">Direct Bill partners and Indirect Providers who have not accepted the Microsoft Partner Agreement will not be able to place new orders and will be limited to managing existing subscriptions only.</span></span>
- <span data-ttu-id="9ef9e-615">Nepřímým prodejcům, kteří nepřijali smlouvu o partnerovi Microsoftu, už nebudou mít nárok na jednání jako partneři záznamů o nových objednávkách.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-615">Indirect Resellers who have not accepted the Microsoft Partner Agreement will no longer be eligible to act as partner of record on new orders.</span></span>

<span data-ttu-id="9ef9e-616">**Pokud jste to ještě neudělali, dokončete prosím tyto akce hned.**</span><span class="sxs-lookup"><span data-stu-id="9ef9e-616">**If you have not done so already, please complete the following actions immediately.**</span></span>

### <a name="actions-for-direct-bill-partners"></a><span data-ttu-id="9ef9e-617">Akce pro partnery s přímým účtováním:</span><span class="sxs-lookup"><span data-stu-id="9ef9e-617">Actions for direct bill partners:</span></span>
1. <span data-ttu-id="9ef9e-618">Informujte klíčové účastníky ve vaší organizaci, aby zkontrolovali smlouvu s partnerem Microsoftu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-618">Inform key stakeholders in your organization to review the Microsoft Partner Agreement.</span></span>
2. <span data-ttu-id="9ef9e-619">Přijměte Smlouvu s partnerem Microsoftu na [stránce přehledu programu CSP v Partnerském centru](https://partner.microsoft.com/pcv/dashboard/overview) s použitím přihlašovacích údajů globálního správce.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-619">Accept the Microsoft Partner Agreement on the [CSP Overview page on Partner Center](https://partner.microsoft.com/pcv/dashboard/overview) using Global Admin credentials.</span></span>

<span data-ttu-id="9ef9e-620">Další informace a prostředky jsou k dispozici prostřednictvím stránky Galerie CSP [zde](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/).</span><span class="sxs-lookup"><span data-stu-id="9ef9e-620">More information and resources are available via the CSP Gallery page [here](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/).</span></span>

### <a name="actions-for-indirect-providers"></a><span data-ttu-id="9ef9e-621">Akce pro nepřímé zprostředkovatele</span><span class="sxs-lookup"><span data-stu-id="9ef9e-621">Actions for indirect providers</span></span>
1. <span data-ttu-id="9ef9e-622">Informujte klíčové účastníky ve vaší organizaci, aby zkontrolovali smlouvu s partnerem Microsoftu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-622">Inform key stakeholders in your organization to review the Microsoft Partner Agreement.</span></span>
2. <span data-ttu-id="9ef9e-623">Přijměte Smlouvu s partnerem Microsoftu na [stránce přehledu programu CSP v Partnerském centru](https://partner.microsoft.com/pcv/dashboard/overview) s použitím přihlašovacích údajů globálního správce.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-623">Accept the Microsoft Partner Agreement on the [CSP Overview page on Partner Center](https://partner.microsoft.com/pcv/dashboard/overview) using Global Admin credentials.</span></span>
3. <span data-ttu-id="9ef9e-624">Použijte [rozhraní API k ověření stavu podepisování nepřímého prodejce](/partner-center/develop/verify-indirect-reseller-mpa-status).</span><span class="sxs-lookup"><span data-stu-id="9ef9e-624">Use the [API to verify your indirect reseller's signing status](/partner-center/develop/verify-indirect-reseller-mpa-status).</span></span>
4. <span data-ttu-id="9ef9e-625">Napomáháte svým nepřímým prodejcům v dokončení jejich akcí.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-625">Assist your indirect resellers with completing their actions below.</span></span>

<span data-ttu-id="9ef9e-626">Další informace a prostředky jsou k dispozici prostřednictvím stránky Galerie CSP [zde](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/).</span><span class="sxs-lookup"><span data-stu-id="9ef9e-626">More information and resources are available via the CSP Gallery page [here](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/).</span></span>

<span data-ttu-id="9ef9e-627">Víme, že technické problémy zjištěné nepřímými poskytovateli testují možnosti transakčního vynucení.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-627">We are aware of technical issues encountered by Indirect Providers testing the transactional enforcement capabilities.</span></span> <span data-ttu-id="9ef9e-628">Tyto problémy budou vyřešeny v dubnu 2020.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-628">Those issues will be resolved by April, 2020.</span></span>

### <a name="actions-for-indirect-resellers"></a><span data-ttu-id="9ef9e-629">Akce pro nepřímé prodejce</span><span class="sxs-lookup"><span data-stu-id="9ef9e-629">Actions for indirect resellers</span></span>
1. <span data-ttu-id="9ef9e-630">Připojte [se k partnerskému centru](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/) jako nepřímý prodejce a jako součást procesu registrace přijměte partnerskou smlouvu Microsoftu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-630">[Onboard to Partner Center](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/) as an indirect reseller and accept the Microsoft Partner Agreement as part of the onboarding process.</span></span>
2. <span data-ttu-id="9ef9e-631">Pokud jste už dříve připojili partnerského centra jako nepřímý prodejce, přijměte na stránce [řídicího panelu partnerského centra](https://partner.microsoft.com/pcv/dashboard/overview) pomocí přihlašovacích údajů globálního správce smlouvu s partnerem Microsoftu.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-631">If you have previously onboarded to Partner Center as an indirect reseller, accept the Microsoft Partner Agreement on the [Partner Center dashboard](https://partner.microsoft.com/pcv/dashboard/overview) page using Global Admin credentials.</span></span>
<span data-ttu-id="9ef9e-632">Informace a prostředky nepřímý prodejce jsou k dispozici [prostřednictvím stránky Galerie](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/)CSP pro prodejce.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-632">Indirect reseller specific information and resources are available via the reseller CSP Gallery page [here](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/).</span></span>

### <a name="change-log"></a><span data-ttu-id="9ef9e-633">Protokol změn</span><span class="sxs-lookup"><span data-stu-id="9ef9e-633">Change log</span></span>

- <span data-ttu-id="9ef9e-634">14. ledna 2020: původní oznámení Publikováno.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-634">January 14, 2020: Original announcement published.</span></span>
- <span data-ttu-id="9ef9e-635">24. ledna 2020: pozvánky webinář Series se aktualizovaly pro w/c 27 leden 2020.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-635">January 24, 2020: Webinar Series invites updated for w/c 27th January 2020.</span></span>
- <span data-ttu-id="9ef9e-636">31. ledna 2020: pozvánky webinář Series byly aktualizovány pro únor 2020.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-636">January 31, 2020: Webinar Series invites updated for February 2020.</span></span>
- <span data-ttu-id="9ef9e-637">5. února 2020: vyžaduje se přijetí smlouvy Microsoft Partner Agreement.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-637">February 5, 2020: Microsoft Partner Agreement acceptance is now required.</span></span>
- <span data-ttu-id="9ef9e-638">4. března 2020: pozvánky webinář Series se aktualizovaly na březen 2020.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-638">March 4, 2020: Webinar Series invites updated for March 2020.</span></span>
- <span data-ttu-id="9ef9e-639">1. dubna 2020: \* \* Update \* \* – aby se zabránilo jakémukoli narušení podniku, bylo rozhodnuto o prodloužení další fáze implementace mimo dubna 2020.</span><span class="sxs-lookup"><span data-stu-id="9ef9e-639">April 1, 2020: \*\* Update\*\* - To help prevent any disruption to business, we have decided to extend the next phase of implementation beyond April 2020.</span></span>
