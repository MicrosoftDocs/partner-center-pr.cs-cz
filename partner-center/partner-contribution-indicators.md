...
Tento článek popisuje sedm klíčových indikátorů příspěvku partnera (PCI) používaných k vyhodnocení pokroku partnera k dosažení nebo zachování kompetence pro silver nebo gold cloud Business Applications kompetence.
...
Díky PCI dostanou partneři kredit za klíčové míry úspěchu zákazníků, jako jsou úspěšná nasazení a zvýšení využití. Jsou odměňovány za to, že nadále investují a škálují své technické možnosti.
...
PCI nabízí sofistikované zobrazení technických možností partnera, jejich schopnost řídit úspěch zákazníků a jejich prodejní výkon. Aby mohli partneři získat Business Applications kompetenci v cloudu pro stříbro nebo Gold, měří PCI výkon vašeho podniku na základě sedmi klíčových ukazatelů:
...
| **Rozvojových** | 150 000 USD | 5  | 5  |*\* Viz poznámka.* | 2 | 1 | 25% |
...
### <a name="table-2-finance-and-operations-thresholds-for-this-competency"></a>Tabulka 2 – Prahové hodnoty pro finance a provoz pro tuto kompetenci
...
- Body čistých přidaných zákazníků se počítají měsíčně, když zákazníci přidávají minus ztráty zákazníků a agregují se za 12 měsíců. 
...
- Za **těchto podmínek** se definuje ztráta zákazníka: Pokud má zákazník v předchozím měsíci alespoň  jednu placenou pozici napříč všemi předplatným a v aktuálním měsíci nemá žádné placené licencí.

- Za čisté zákaznické přičtení je možné získat maximální a částečné body. Následující příklad ukazuje požadavky na získání maximálního počtu bodů pro danou kompetenci:

  | Pro tuto cestu | Čistý zákazník přidá k získání maximálně 10 bodů |
  |---------------------|----------------------------|
  | Customer Engagement | – 10 čistých zákaznických přidání (pro partnery na *vyvinutých trzích)*</br>– 5 čistých zákaznických přidání (pro partnery na *vývoji trhů)*  |
  | Finance and Operations | – 3 čisté zákaznické doplňky (pro partnery na *vyvinutých trzích),*</br>– 1 přidání nového zákazníka (pro partnery na *vývoji trhů)* |
...
- Pro více partnerů nebo stejných zákazníků nebo zákazníků pracujících přímo  s Microsoftem: Existují různé výpočty přidání zákazníků a ztráty zákazníků v případech, kdy je více partnerů přidruženo ke stejnému zákazníkovi prostřednictvím různých předplatných nebo v případech, kdy zákazník již může pracovat přímo s Microsoftem.  Tyto výpočty jsou uvedené níže.

  **Pro více partnerů, stejného zákazníka a různá předplatná:**

  - Všichni partneři přidružení k zákazníkovi 1. měsíc, kdy se zákazník přidá, pomocí kreditu přidá nového zákazníka.
  
  - Další partneři přidružení ke stejnému zákazníkovi prostřednictvím starých nebo nových předplatných nezískují pro tohoto zákazníka kredit pro nového zákazníka.
...
Partner má jednu ze dvou možností, jak pro tuto metriku dosáhnout bodů "vše nebo nic" (15 nebo 0 bodů). Nebudou uděleny žádné částečné body.
...
- Snímek směrného plánu se následně resetuje k dalšímu datu prodloužení Business Applications cloudové kompetence.

- Abyste měli nárok na body, musíte mít minimálně **15** spolupracovníků Konzultanti funkcí pro vyvinuté partnery na trhu a **5** pro partnery vyvíjející se na trhu, když se pořídí základní snímek.

- **Nebudou uděleny žádné částečné body.** Růst nad snímkem směrného plánu musí splňovat nebo překročit prahové hodnoty uvedené v následující tabulce. V tabulce je sloupec Developed and **Developing** **(Vývoj)** se standardními plány konzultantů pro funkce, které jsou potřeba k získání bodů.

  | Vyvinut | Rozvojových | Růst potřebný k získání všech 15 bodů
  |:---:|:---:|:---:|
  | 15-29 | 5-14 | 35 % |
  | 30–49 | 15-24 | 25% |
...
Vývojáři jsou [indikátorem schopností](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators). Body tohoto ukazatele se počítají pro Cloud Business Applications kompetenci následujícím způsobem:
...
> [!NOTE]
> Zkoušky označené hvězdičkou ( ) se v nadcházejících měsících vyřazené \* nebo nahrazené. Konkrétní podrobnosti najdete níže:
>
...
- Partneři jsou přidruženi ke klientům na úrovni předplatného. Předplatná jsou namapována na následující, opravňující produkty pro zapojení do zákazníků nebo finanční a provozní produkty:
  - Produkty opravňující k zapojení zákazníků zahrnují: Sales, Customer Service, Field Service, automatizace služeb projektu, marketing, Microsoft Relationship Sales, plán 1, talentů a člen týmu podniku.
  - Mezi finance a provoz opravňující produkty patří: sjednocené operace, finance, Správa dodavatelských řetězců, maloobchodní prodej, obchod, plán 2, smíšený realita, talentů a člen podnikového týmu.
...
Měsíčně aktivním růstem uživatelů je [indikátor úspěšnosti zákazníka](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators). Body tohoto ukazatele se počítají pro Cloud Business Applications kompetenci následujícím způsobem:
...
- Všichni partneři přidružení ke všem placeným předplatným v rámci tenanta získá kredit za všechny měsíční aktivní uživatele Customer Engagement nebo Finance and Operations shrňované ve všech placených předplatných v rámci tohoto tenanta.

## <a name="how-to-access-partner-contribution-indicators"></a>Jak získat přístup k indikátorům příspěvků partnerů

Tato část popisuje, jak získat přístup k indikátorům příspěvků pro partnery z řídicího Partnerské centrum a jak číst přidružené grafy.
...
Podívejte se na další [videa o školeních PCI a informativní materiály](https://partner.microsoft.com/asset/collection/pci-learn#/) o tom, jak dosáhnout Gold nebo stříbrného cloudu Business Applications kompetenci.
