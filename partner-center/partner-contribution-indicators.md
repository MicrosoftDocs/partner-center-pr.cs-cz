...
### <a name="table-2-finance-and-operations-thresholds-for-this-competency"></a>Tabulka 2 – prahové hodnoty finančních prostředků a operací pro tuto kompetenci
...
- Maximální a částečné body lze získat pro přidat k čistému zákazníkovi. Níže jsou uvedeny požadavky na získání maximálního počtu bodů pro danou kompetenci:

  | Pro tento chodník | Čistý zákazník přičítá k získání maximálního počtu 10 bodů. |
  |---------------------|----------------------------|
  | Customer Engagement | – 10 čistý zákazník přidává (pro partnery na *vyvíjených* trzích);</br>-5 čistý zákazník přidává (pro partnery na *vývoji* trhů)  |
  | Finance and Operations | -3 čistý zákazník přidává (pro partnery na *vyvíjených* trzích);</br>-1 nové zákaznické přidání (pro partnery na *vývoji* trhů) |

  > [!NOTE]
  > Podrobnosti o vyvinutých a vývoji trhů najdete v následujících [definicích Microsoft Partner Network](https://assetsprod.microsoft.com/mpn/mpn-developed-and-developing-countries.pdf).
...
>
> - Zkoušky označené jednou hvězdičkou ( \* ) byly vyřazení od 31. prosince 2020. Zkoušky, které se od 31. prosince 2020, budou mít nárok na dosažení kompetence a prodloužení do 31. prosince 2021, pokud je před jejich vyřazením.
...
Růst funkčního konzultanta je [indikátorem schopností](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators). Body tohoto ukazatele se počítají pro Cloud Business Applications kompetenci následujícím způsobem:

Partner má jednu ze dvou možností, jak dosáhnout všech bodů (15 nebo 0 bodů) dostupných pro tuto metriku. Žádné částečné body nebudou uděleny.
...
- Měsíční nárůst pro zákazníky je definován odlišně pro zapojení zákazníků vs. finance a provozní cesty a pro partnery pracující na *vyvíjených* trzích vs. *vývoj* trhů:
  ...
  (Podrobné informace o vývoji vs. vývoj trhů najdete v těchto [Microsoft Partner Network definicích](https://assetsprod.microsoft.com/mpn/mpn-developed-and-developing-countries.pdf.) .
