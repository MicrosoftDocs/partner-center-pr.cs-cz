...
Pokud máte pobočky v různých zemích, můžete v těchto zemích vytvořit umístění MPN a získat ID MPN umístění. Pak můžete použít tato umístění MPN ID k registraci do programu CSP, sdílet informace s vašimi nepřímými poskytovateli a získat pobídky. 
...
Pokud nemůžete problém vyřešit sami, vyvolejte lístek podpory v rámci partnerského centra tím, že se přihlásíte pomocí účtu CSP a:

- V případě problémů s ověřováním firmy vytvořte [žádost o podporu](https://partner.microsoft.com/dashboard/support/servicerequests/create?stage=2&topicid=52ac28f3-d58f-99d9-9846-3df5a6477c54).  
- V případě problémů s ověřováním zaměstnanosti vytvořte [žádost o podporu](https://partner.microsoft.com/dashboard/support/servicerequests/create?stage=2&topicid=c34a5c81-a111-476d-11a4-81c808c37a6b).
...
Pokud je stav cokoli jiného, ale **aktivní**, znamená to, že právní ověření obchodního profilu ještě probíhá, nebo se zamítlo. Na stejné stránce by měl prodejce kontrolovat stav ověření a kliknutím na **Další informace tento problém opravit** , aby prodejce mohl poskytnout potřebnou dokumentaci pro pokračování v ověřování.

:::image type="content" source="images/active-status.png" alt-text="Stav je aktivní.":::

Pokud Váš prodejce potřebuje podporu při předávání dodržování předpisů pro obchodní profil, požádejte je, aby otevřel lístek a zvolil tyto možnosti:
...
- [Naučte se, jak v programu Cloud Solution Provider spolupracuje s nepřímými poskytovateli.](indirect-reseller-tasks-in-partner-center.md)
