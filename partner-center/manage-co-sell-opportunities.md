...
Využijte výhod společného prodejního příležitosti.  Příležitosti společného prodeje představují spolupráci více stran při prodeji produktů, které splňují požadavky zákazníků. Tento článek vám pomůže pochopit, jak můžete využít sílu společného prodeje v partnerském centru, abyste mohli efektivně prodávat a získávat nové zákazníky.

## <a name="types-of-co-sell-opportunities"></a>Typy příležitostí společného prodeje

**Společný prodej** – tady je jeden nebo více prodejců Microsoftu, kteří se aktivně podílejí na řešení problémů zákazníků. Příležitosti můžou pocházet z účtu zákazníka, kde obchodní zástupce Microsoftu pozve partnera k účasti na aktivitě spoluprodejní nebo od partnera, kde od Microsoftu potřebuje další technickou podporu k uzavření obchodu.
...
**Soukromá koupě** – jedná se o případ, kdy se partner rozhodne pracovat nezávisle na koupi, která byla vytvořena v partnerském centru. Partneři mají možnost pozvat prodejce Microsoftu po vytvoření obchodu a učinit tak spolupráci v rámci spolupráce. Podrobnosti o obchodování se nesdílí s prodejním týmem Microsoftu až do doby, kdy partner výslovně požádá o prodejní podporu Microsoftu.
...
V této části je potřeba poskytnout informace související s řešeními, která budou součástí této práce. Toto je povinná část, kde musíte přidat aspoň jedno řešení, abyste mohli vytvořit obchod. Podrobnosti řešení je možné změnit po vytvoření koupě. Existuje několik typů řešení, které je možné přidat do obchodu, které jsou popsány níže.

- **Moje firemní řešení:** Jedná se o řešení připravená pro spoluprodej, která jsou publikovaná ve vaší společnosti.
- **Microsoft:** Jedná se o řešení vlastněná Microsoftem.
- **Další řešení třetích stran:** Jedná se o řešení připravená pro spoluprodej, která jsou publikovaná jinými partnery v ekosystému pro spoluprodejní účast Microsoftu.
- **Posouzení řešení:** Jedná se o typy posouzení, které může oprávněný partner vybrat na základě potřeby zákazníka.

> [!Important]
> Pro posouzení řešení lze vybrat pouze jeden typ posouzení a nelze přidat žádná další řešení. Jakmile vyberete hodnocení řešení, musí partner zvolit umístění, pro které se hodnocení vytváří. To je potřeba pro správné výběry s pobídkou.
...
- **Odhadovaná hodnota a měna:** Jedná se o hodnotu, kterou pozvaní partner bude mít v celkovém obchodu. Ujistěte se, že do tohoto pole zadáte správnou hodnotu, aby pozvaní partneři mohla rozhodnout, jestli chtějí být součástí obchodu, nebo ne. Pozvaní partner může tuto hodnotu po vytvoření obchodu změnit. Po vytvoření obchodu nelze toto pole změnit.

- **Poznámky:** Přidejte podrobnosti o tom, proč zvete partner jako součást tohoto obchodu. Podrobné informace pomůžou pozvanému partnerovi rozhodnout se, jestli se chce zúčastnit.

- **Přidejte svůj tým:** Přidejte zaměstnance z vaší společnosti, kteří budou pracovat s pozvaným partnerem. Pokud pozvaní partner přijme obchod, může přidat své vlastní zaměstnance, aby obě společnosti měly přehled o obchodování na obchodech. Tyto podrobnosti můžete změnit pouze před vytvořením obchodu. Údaje o zaměstnancích zadaných v datech o koupi jsou předem vyplněné, což vám usnadní výběr zaměstnanců, kteří s tímto konkrétním partnerem pracují.

- **Přidat řešení:**  Přidejte řešení, která má přizvaní partner přenést do tabulky. Minimálně jedno řešení je povinné. Pozvaní partner může po přijetí pozvánky upravit řešení.

- **Určete typ nápovědě:** Identifikujte typ pomocníka: nakonec Určete konkrétní potřebnou podporu od pozvaného partnera.

Tuto akci opakujte pro všechny partnery, které chcete pozvat, aby byly součástí této práce. Partnerský obchod se může také dodílet na partnerovi Microsoftu, kde zvete Microsoftu i partneři do obchodu. Po vytvoření obchodu můžete také požádat o Microsoft i partnery později.
...
> [!Important]
> Jak přezkoumání obchodu, tak i konečný stav ověření platí jenom pro obchod s protokolem IP v prodeji.

### <a name="combinations"></a>Pínací

V následující tabulce jsou uvedeny kombinace, které mohou být v této fázi obchodu pozvány.

|**Původní typ kouposti**|**Kdo může být přizván**|**Poznámky**|
|-----|:-----|:-----|
...
|Partner k partnerovi bez Microsoftu|Partnerský vztah Microsoftu|Obchod se upgraduje na obchod v rámci společného prodeje.|
...
**Dotazu. Je možné úpravu obchodu po označení výhry nebo ztráty?**
