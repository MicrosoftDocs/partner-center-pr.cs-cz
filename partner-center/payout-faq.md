...
**Příslušné role**: správce účtu | Globální správce | Motivace správce
...
Závisí to na potřebách vaší organizace. Platební profily se vytvářejí na úrovni organizace, což umožňuje přiřazení stejného bankovního profilu napříč několika ID MPN a programy v rámci organizace. Ve většině případů můžete buď znovu použít existující profil, nebo vytvořit nový.
...
Daňové profily vytvořené pro umístění MPN se znovu použije a automaticky vyplní, když se stejné umístění MPN zapojí do jiného programu. Můžou však existovat výjimky. Například pravidla pro platby nového programu pobídek můžou v daňovém profilu vyžadovat další podrobnosti.

#### <a name="can-i-use-the-same-bank-and-tax-details-for-all-incentive-programs-at-microsoft"></a>Můžu pro všechny programy pobídek v Microsoftu použít stejné bankovní a daňové údaje?

Pokud je vaše společnost pozvána k více programům, můžete použít stejný platební účet pro všechny vaše programy nebo můžete zvolit, aby pro různé programy byly různé platební účty.


#### <a name="how-does-microsoft-ensure-that-the-bank-information-is-indeed-that-of-the-company-and-not-a-personal-bank-account-for-an-employee"></a>Jak Microsoft zajistí, aby bankovní údaje skutečně byly bankovními informacemi společnosti, a nikoli osobním bankovním účtem zaměstnance?

Společnost zodpovídá za to, aby role správce pobídek , který má oprávnění k úpravám těchto informací, byla udělena pouze příslušným zaměstnancům.

#### <a name="my-tax-profile-has-expired-how-do-i-fix-update-it"></a>Vypršela platnost mého daňového profilu. Návody jste ji opravíte?

Pokud vypršela platnost daňového profilu nebo brzy vyprší jeho platnost, je potřeba aktualizovat daňový formulář, který jste poskytli Microsoftu. K aktualizaci daňového profilu použijte následující postup:

1. Přihlaste se k Partnerské centrum [a](https://partner.microsoft.com/dashboard/home)výběrem ikony ozubeného kola otevřete **nabídku** Nastavení.
2. Vyberte **Nastavení účtu,** rozbalte **oddíl Výplaty** a daně a pak vyberte **Platební a daňový** profil.
3. Vyberte **Daňový** profil.
4. Zkontrolujte sloupec **Datum vypršení platnosti** a přejděte na daňový profil, jehož platnost vypršela nebo brzy vyprší.
5. Výběrem **možnosti** Upravit spusťte proces úpravy daňového profilu.
6. V části Daňový formulář zadejte aktualizované podrobnosti.

## <a name="earnings-incorrect-or-missing"></a>Příjmy jsou nesprávné nebo chybí
...
- SaaS a IaaS nabídky mají poplatky za zlevněnou agenturu na 10% místo na úrovni Standard 20%, takže se sazba příjmů 90%. Toto je požadavek Co-Sell protokolu IP. Tato propagační akce platí do 30. června 2021. 
...
**Další** materiály: [Smlouva o vydavateli komerčního tržiště](/legal/marketplace/msft-publisher-agreement), [Podrobnosti o](payout-policy-details.md)vydaných zásadách, [Podrobnosti o daních](tax-details-marketplace.md), [prahová hodnota platby, metoda a časový rámec](payment-thresholds-methods-timeframes.md)
...
**Další** materiály: [Smlouva o vydavateli komerčního tržiště](/legal/marketplace/msft-publisher-agreement), [Podrobnosti o](payout-policy-details.md) vydaných zásadách
...
V historickém výpisu se zobrazí snímek údajů o platbách k říjnu 2019. Informace o výběrech se bohužel neaktualizují. Pokud chcete získat nejnovější informace, odešlete lístek podpory s nejnovějšími daty.
...
## <a name="payout-export-api"></a>Rozhraní API pro export výplat

#### <a name="how-do-i-download-payout-data"></a>Jak si můžu stáhnout údaje o platbách?

Použijte rozhraní [PARTNER Payout API](https://apidocs.microsoft.com/services/partnerpayouts).

## <a name="commercial-marketplace-payout-policies"></a>Zásady výplaty na komerčním marketplace

#### <a name="how-do-i-find-the-current-agency-fee-and-the-payout-rate"></a>Jak zjistím aktuální výši provize a výplaty?

- Projděte si smlouvu pro vydavatele na komerčním marketplace. Standardní provize je 20 %. U transakcí způsobilých ke spoluhodě SaaS se účtuje poplatek 10 %. Informace o případných propagačních provizích najdete v oznámeních.
- Ve výpisu platby určuje sazba za příjmy skutečnou sazbu za výplatu pro danou transakci.
...
- Jakmile budou vaše příjmy v nezpracovaném stavu, můžete zkontrolovat datum splatnosti a zjistit tak, ve kterém měsíci se zpracuje jejich platba. Jakmile je vaše platba připravená, stav příjmů se změní na "zpracovaný".  Microsoft uvolňuje platby do 15. dne měsíce splatnosti.
- V případě objednávek placených platební kartou Microsoft drží platby 30 dní, dokud se příjmy nedozrály.

 **Další čtení:** Smlouva vydavatele [na komerčním marketplace,](/legal/marketplace/msft-publisher-agreement) [podrobnosti o zásadách plateb,](payout-policy-details.md) [podrobnosti o daních,](tax-details-marketplace.md)prahová hodnota [platby, způsob](payment-thresholds-methods-timeframes.md) a časový rámec

## <a name="next-steps"></a>Další kroky

- [Vyplacení](marketplace-get-paid.md)
