...
### <a name="partner-information"></a><a href="" id="partner_info"></a>Informace o partnerovi
...
Pokud ještě nemáte stránku LinkedIn společnosti, můžete si ji [vytvořit](https://www.linkedin.com/company-beta/setup/new/).
...
#### <a name="allow-microsoft-to-endorse-my-areas-of-expertise"></a><a href="" id="#allow_us_to_endorse_areas_of_expertise"></a>Umožněte Microsoftu, aby potvrdil mé oblasti odbornosti.
...
#### <a name="target-size"></a><a href="" id="#target_size"></a>Cílová velikost
...
#### <a name="locations"></a><a href="" id="#locations"></a> Polohy

Do každé oblasti můžete přidat až 5 hlavních umístění vaší organizace. Tato umístění se zobrazí, když zákazníci hledají blízkost k partnerům.
