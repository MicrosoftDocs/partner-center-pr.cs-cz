...
K dispozici je několik důvodů, proč při přístupu k analýzám společného prodeje, jak je popsáno níže, máte prázdný graf podobný následujícímu.
...
- Stránka se načte s výchozím filtrem pro společné obchody. Pokud máte jenom soukromé obchody, resetujte filtr typu koupě.
- K použitým filtrům neodpovídají žádné záznamy. Zkuste filtry resetovat.
- Došlo ke zpoždění mezi změnou stavu příležitosti a stejnou aktualizací v sestavě Analytics. Ověřte sestavu po 24 hodinách.
...
> [!NOTE]
> Na stránce **Přehledy referenčních seznamů** se zobrazují pouze data referenčních seznamů vygenerovaných v Partnerském centru. Nezobrazuje data pro reference vygenerovaná prostřednictvím obchodního [připojení partnera](psc-to-pc.md) nebo jiných mechanismů.
