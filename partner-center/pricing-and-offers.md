...
Nejnovější programy a nabídky poskytovatele Cloud Solution Provider (CSP) zobrazíte tak, že na řídicím panelu portálu pro partnery přejdete na **prodávat > ceny a nabídky**. Pro různé typy produktů, které jsou k dispozici, najdete samostatné ceníky. Následující ceníky jsou k dispozici na stránce **ceny a nabídky** :

- **Služby založené na licencích** zahrnují informace o cenách pro Office 365, Enterprise mobility a zabezpečení E3 a Dynamics 365. V části s cenami na základě licence patří aktuální ceny a verze Preview a matice seznamu nabídek. Ceníky zahrnují Ceník a odhadované maloobchodní ceny (ERP) pro nabídky ve všech podporovaných měnách. Matice seznamu nabídek zahrnuje dostupnost trhu a další důležité informace o nabídkách. Tyto soubory se aktualizují poprvé dne v každém měsíci.
...
Ceny na základě využití se můžou v průběhu měsíce měnit. Pokud chcete získat aktuální denní ceny těchto prostředků Azure, partneři musí volat rozhraní RateCard API. 

> [!Note] 
> Změny cen předplatného platí jenom při obnovení. Měsíční poplatek partnera se určuje podle ceny nákupu nebo ceny v době vytváření předplatného. Pokud se cena zvýší nebo sníží po uplynutí ročního období, partner se nebude účtovat za změněnou cenu, dokud neproběhne na 12 měsíců.
...
3. Přejděte k zákazníkovi ze seznamu zákazníků. Vyberte předplatné pro základní nabídku, kterou jste právě koupili. Na stránce Spravovat předplatné uvidíte dostupné doplňky, které se dají použít pro základní nabídku.
...
Ceny se liší v různých typech nabídek. Ceny založené na licencích jsou obvykle částka na licenci za daný měsíc. Ceny založené na využití se určují pomocí daného prostředku s přiřazeným ID měřiče. Partnerům se neúčtují za získání předplatného Azure. Partneři se ale účtují za prostředky spotřebované různými nasazeními v rámci předplatného Azure. Ceny v ceníku založené na využití jsou v Azure seřazené podle různých ID měřičů prostředků.

Rezervace Azure jsou na základě termínu nákupy pro konkrétní typ prostředku – Virtual Machines. Nákupem rezervace Azure umožníte partnerům předplatit (jeden nebo tři roky) a rezervovat daný virtuální počítač. Rezervace šetří peněžní peníze a zajišťuje, aby jejich virtuální počítač byl vždy k dispozici po dobu trvání tohoto období. Partner může podle ID měřičů prostředků na základě využití zarovnat rezervace, které chtějí. ID měřičů jsou v rámci tohoto prostředku konzistentní, bez ohledu na to, jestli partner koupí virtuální počítač, nebo jednoduše nasadí virtuální počítač jako prostředek založený na využití.
...
> [!IMPORTANT]
> Omezení souběžnosti se vynutilo i v případě, že se nabídka zruší. Nabídka se musí zcela zrušit a pak zrušit její zřízení, aby se uvolnilo další místo umožňující další nákup.

### <a name="taxes-and-pricing"></a>Daně a ceny

Všechny ceny v seznamech ceníků partnerského centra pro partnery jsou daně včetně. Další informace v partnerském centru jsou [daně a daňové odchylky](tax-and-tax-exemptions.md).

## <a name="multi-year-term-offers"></a>Nabídky s více roky
...
|**Produkt nebo služba**        |**Podrobnosti o ceníku ERP a MSRP**      |
|:-----------   |:-----------   |
|Produkt nebo služba  |Podrobnosti o ceníku ERP a MSRP  |
...
- [Ceny plánu Azure](azure-plan-price-list.md)
